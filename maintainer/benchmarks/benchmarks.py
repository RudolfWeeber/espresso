...
def get_timings(system, n_steps, n_iterations, verbose=True, retune_skin_after_steps=None):
    '''
    ...
    retune_skin_after_steps: :obj:`int`, optional
        If provided, retune the skin every this many iterations to +-10% 
    ...
    for i in range(n_iterations):
        ...
        if retune_skin_after_steps is not None and i % retune_skin_after_steps == 0:
            ...
            if verbose:
                print(f"Retuning skin at iteration {i} (current: {
                      current_skin:.3f}, range: [{min_skin_retune:.3f}, {max_skin_retune:.3f}])")
