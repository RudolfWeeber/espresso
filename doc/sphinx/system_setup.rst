...
With the regular decomposition cell system, Lees-Edwards boundary conditions
update the ghost-cell neighborships dynamically as the shear offset evolves,
so no special decomposition setting is required. The MPI node grid must have exactly
