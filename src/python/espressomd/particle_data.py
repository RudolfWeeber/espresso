...
class ParticleHandle(ScriptInterfaceHelper):
    ...
    swimming:
        ...
        speed (``v_swim``) can be calculated from the friction (``gamma``) of a thermostat:
        ``v_swim = f_swim / gamma``.
        If you resolve hydrodynamics in your simulation (via lattice Boltzmann), you can 
        ...
        is_engine_force_applier : :obj:`bool`
            Default: ``False``. 
