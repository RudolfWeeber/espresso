...
struct AoSoA_pack {
   ...
   AoSoA_pack(AoSoA_type &aosoa)
     : position(Cabana::slice<0>(aosoa)),
       force(Cabana::slice<1>(aosoa)),
       torque(Cabana::slice<2>(aosoa)),
       charge(Cabana::slice<3>(aosoa)),
       id(Cabana::slice<4>(aosoa)),
       type(Cabana::slice<5>(aosoa)),
