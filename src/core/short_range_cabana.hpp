...
inline void set_offset_and_size_indexed_by_cid( int &total_bins, int* cell_num,
...
void cabana_short_range(
  ...
  if (pair_cutoff > 0.) {
	...
	delta_lebc[le_direction] =
      ...
      set_offset_and_size_indexed_by_cid(total_bins, cell_num, cell_list, bin_offset, bin_size);
