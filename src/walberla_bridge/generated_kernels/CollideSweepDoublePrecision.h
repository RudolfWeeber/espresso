...
//
//! \\file CollideSweepDoublePrecision.h
//! \\author pystencils
//======================================================================================================================
...
class CollideSweepDoublePrecision {
public:
  CollideSweepDoublePrecision(BlockDataID forceID_, BlockDataID pdfsID_,
  ...
  getSweep(const shared_ptr<CollideSweepDoublePrecision> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)>
  getSweepOnCellInterval(const shared_ptr<CollideSweepDoublePrecision> &kernel,
