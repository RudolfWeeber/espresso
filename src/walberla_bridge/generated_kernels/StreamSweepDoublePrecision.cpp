...
static FUNC_PREFIX void streamsweepdoubleprecision_streamsweepdoubleprecision(
...
void StreamSweepDoublePrecision::run(IBlock *block) {
  ...
  internal_streamsweepdoubleprecision_streamsweepdoubleprecision::
      streamsweepdoubleprecision_streamsweepdoubleprecision(
...
void StreamSweepDoublePrecision::runOnCellInterval(
