  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const float xi_220 = _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0];
        const float xi_221 = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0];
        const float xi_222 = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0];
        const float xi_223 = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0];
        const float xi_224 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_225 = _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0];
        const float xi_226 = _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0];
        const float xi_227 = _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0];
        const float xi_228 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        const float xi_229 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const float xi_230 = _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0];
        const float xi_231 = _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0];
        const float xi_232 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        const float xi_233 = _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0];
        const float xi_234 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        const float xi_235 = _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_236 = _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0];
        const float xi_237 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const float xi_238 = _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_239 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        const float xi_240 = _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        const float xi_241 = _data_force_20_31_10[_stride_force_0 * ctr_0];
        ...
        const float xi_111 =
            omega_even *
            (xi_107 + xi_110 + xi_220 * -5.0f + xi_225 * -2.0f +
             xi_231 * -5.0f + xi_234 * -5.0f + xi_236 * -2.0f + xi_237 * -5.0f);
        ...
        const float xi_125 =
            omega_even *
            (xi_106 + xi_110 + xi_122 + xi_123 + xi_124 + xi_223 * -7.0f +
             xi_225 * 5.0f + xi_226 * -7.0f + xi_228 * -7.0f + xi_230 * -7.0f +
             xi_232 * -4.0f + xi_235 * -4.0f + xi_236 * 5.0f);
        ...
        const float xi_191 = xi_171 * (u_2 * xi_137 + xi_126 + xi_18 + xi_239);
        ...
        const float xi_207 = xi_171 * (u_2 * xi_151 + xi_11 + xi_154 + xi_234);
