    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_34;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
             ctr_0 += 4) {
          const __m256d xi_268 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
          ...
          const __m256d xi_271 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
          const __m256d xi_272 = _mm256_load_pd(&_data_pdfs_20_33_10[ctr_0]);
          const __m256d xi_273 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          const __m256d xi_274 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
          ...
          const __m256d xi_277 = _mm256_load_pd(&_data_pdfs_20_35_10[ctr_0]);
          const __m256d xi_278 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
          const __m256d xi_279 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
          const __m256d xi_280 = _mm256_load_pd(&_data_pdfs_20_39_10[ctr_0]);
          const __m256d xi_281 = _mm256_load_pd(&_data_pdfs_20_317_10[ctr_0]);
          const __m256d xi_282 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
          const __m256d xi_283 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
          const __m256d xi_284 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
          const __m256d xi_285 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
          const __m256d xi_286 = _mm256_load_pd(&_data_force_20_31_10[ctr_0]);
          const __m256d xi_287 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
          const __m256d xi_288 = _mm256_load_pd(&_data_pdfs_20_36_10[ctr_0]);
          ...
          const __m256d xi_0 = _mm256_add_pd(xi_269, xi_279);
          const __m256d xi_1 = _mm256_add_pd(xi_0, xi_289);
          const __m256d xi_2 =
              _mm256_add_pd(_mm256_add_pd(xi_270, xi_285), xi_287);
          const __m256d xi_3 = _mm256_add_pd(xi_268, xi_277);
          const __m256d xi_4 = _mm256_add_pd(xi_272, xi_280);
          const __m256d xi_5 = _mm256_add_pd(xi_273, xi_278);
          const __m256d xi_6 = _mm256_add_pd(xi_281, xi_288);
          const __m256d xi_9 =
          ...
          const __m256d xi_25 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(xi_18, xi_23), xi_24), xi_285);
          const __m256d xi_30 = _mm256_mul_pd(
              xi_286, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                    0.166666666666667, 0.166666666666667));
          const __m256d xi_31 = _mm256_mul_pd(
              xi_286, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
          ...
          const __m256d xi_51 = _mm256_mul_pd(
              xi_283, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_68 =
              _mm256_mul_pd(xi_286, _mm256_set_pd(0.25, 0.25, 0.25, 0.25));
          const __m256d xi_73 =
              _mm256_mul_pd(xi_286, _mm256_set_pd(xi_72, xi_72, xi_72, xi_72));
          const __m256d xi_113 =
              _mm256_mul_pd(xi_274, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
          const __m256d xi_114 = _mm256_add_pd(
              _mm256_add_pd(
                  _mm256_mul_pd(xi_277, _mm256_set_pd(3.0, 3.0, 3.0, 3.0)),
                  _mm256_mul_pd(xi_288, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))),
              xi_113);
                  ...
                  _mm256_add_pd(
                      _mm256_add_pd(
                          _mm256_add_pd(
                              _mm256_add_pd(
                                  _mm256_add_pd(
                                      _mm256_mul_pd(xi_268,
                                                    _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0)),
                                      _mm256_mul_pd(xi_270,
                                                    _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0))),
                                  _mm256_mul_pd(
                                      xi_273,
                          ...
                          _mm256_mul_pd(xi_285,
                                        _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                      _mm256_mul_pd(xi_287, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))),
                  xi_114),
                                      ...
                                      _mm256_add_pd(
                                          ...
                                          _mm256_mul_pd(
                                              ...
                                              _mm256_set_pd(-2.0, -2.0, -2.0,
                                                            -2.0))),
                                      _mm256_mul_pd(xi_279,
                                                    _mm256_set_pd(-5.0, -5.0,
                                                                  -5.0, -5.0))),
                                  _mm256_mul_pd(
                                      xi_281,
                                      _mm256_set_pd(-5.0, -5.0, -5.0, -5.0))),
                              _mm256_mul_pd(xi_282, _mm256_set_pd(-5.0, -5.0,
                                                                  -5.0, -5.0))),
          ...
          const __m256d xi_129 =
              _mm256_mul_pd(xi_282, _mm256_set_pd(2.0, 2.0, 2.0, 2.0));
          ...
          const __m256d xi_131 = _mm256_add_pd(
              ...
              _mm256_mul_pd(xi_281, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)));
          const __m256d xi_132 = _mm256_mul_pd(
              _mm256_add_pd(
                  ...
                  xi_131),
              _mm256_set_pd(omega_even, omega_even, omega_even, omega_even));
          const __m256d xi_133 = _mm256_add_pd(xi_121, xi_268);
          ...
          const __m256d xi_138 = _mm256_add_pd(xi_123, xi_284);
          ...
          const __m256d xi_162 = _mm256_add_pd(xi_281, xi_282);
          const __m256d xi_176 = _mm256_add_pd(xi_126, xi_282);
          ...
          const __m256d xi_188 = _mm256_add_pd(xi_270, xi_273);
          const __m256d xi_189 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(xi_122, xi_188), xi_24), xi_277);
          ...
          const __m256d xi_60 =
              _mm256_mul_pd(xi_286, _mm256_set_pd(xi_54, xi_54, xi_54, xi_54));
          const __m256d xi_82 =
              _mm256_mul_pd(xi_283, _mm256_set_pd(xi_54, xi_54, xi_54, xi_54));
          const __m256d vel0Term =
              _mm256_add_pd(_mm256_add_pd(xi_1, xi_271), xi_284);
          const __m256d vel1Term = _mm256_add_pd(xi_2, xi_275);
          const __m256d vel2Term = _mm256_add_pd(xi_282, xi_3);
              ...
              _mm256_mul_pd(
                  ...
                  _mm256_add_pd(
                      _mm256_add_pd(
                          ...
                          xi_271),
                      xi_9)),
              _mm256_mul_pd(xi_286, xi_8));
          const __m256d xi_27 = _mm256_mul_pd(u_1, xi_286);
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_268 = _data_pdfs_20_312_10[ctr_0];
          const double xi_269 = _data_pdfs_20_314_10[ctr_0];
          const double xi_270 = _data_pdfs_20_315_10[ctr_0];
          const double xi_271 = _data_pdfs_20_38_10[ctr_0];
          const double xi_272 = _data_pdfs_20_33_10[ctr_0];
          const double xi_273 = _data_pdfs_20_316_10[ctr_0];
          const double xi_274 = _data_pdfs_20_30_10[ctr_0];
          const double xi_275 = _data_pdfs_20_37_10[ctr_0];
          const double xi_276 = _data_force_20_30_10[ctr_0];
          const double xi_277 = _data_pdfs_20_35_10[ctr_0];
          const double xi_278 = _data_pdfs_20_32_10[ctr_0];
          const double xi_279 = _data_pdfs_20_318_10[ctr_0];
          const double xi_280 = _data_pdfs_20_39_10[ctr_0];
          const double xi_281 = _data_pdfs_20_317_10[ctr_0];
          const double xi_282 = _data_pdfs_20_313_10[ctr_0];
          const double xi_283 = _data_force_20_32_10[ctr_0];
          const double xi_284 = _data_pdfs_20_310_10[ctr_0];
          const double xi_285 = _data_pdfs_20_311_10[ctr_0];
          const double xi_286 = _data_force_20_31_10[ctr_0];
          const double xi_287 = _data_pdfs_20_31_10[ctr_0];
          const double xi_288 = _data_pdfs_20_36_10[ctr_0];
          ...
          const double xi_167 =
              ...
              (xi_10 + xi_116 + xi_119 * 2.0 + xi_123 - xi_124 + xi_127 +
               xi_163 + xi_272 * -2.0 + xi_278 + xi_287 + xi_289 * -2.0);
          const double xi_169 =
          ...
          const double xi_226 =
              xi_216 * (u_2 * xi_137 + xi_133 + xi_18 + xi_270);
          const double xi_230 =
