...
{
public:
    CollideSweepDoublePrecisionLeesEdwards( BlockDataID forceID_, BlockDataID pdfsID_, BlockDataID velocityID_, double omega_bulk, bool points_down, bool points_up )
