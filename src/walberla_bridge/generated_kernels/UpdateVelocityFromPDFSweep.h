...
public:
  UpdateVelocityFromPDFSweep(BlockDataID forceID_, BlockDataID pdfsID_,
  ...
  getSweep(const shared_ptr<UpdateVelocityFromPDFSweep> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)>
  getSweepOnCellInterval(const shared_ptr<UpdateVelocityFromPDFSweep> &kernel,
