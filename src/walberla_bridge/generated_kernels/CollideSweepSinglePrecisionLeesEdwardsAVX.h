...
{
public:
    CollideSweepSinglePrecisionLeesEdwardsAVX( BlockDataID forceID_, BlockDataID pdfsID_, BlockDataID velocityID_, float omega_bulk, bool points_down, bool points_up )
