    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_315;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
             ctr_0 += 4) {
          const __m256d xi_63 = _mm256_load_pd(&_data_velocity_20_30_10[ctr_0]);
          const __m256d xi_64 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
          const __m256d xi_65 = _mm256_load_pd(&_data_force_20_30_10[ctr_0]);
          const __m256d xi_66 = _mm256_load_pd(&_data_pdfs_20_39_10[ctr_0]);
          const __m256d xi_67 = _mm256_load_pd(&_data_pdfs_20_36_10[ctr_0]);
          const __m256d xi_68 = _mm256_load_pd(&_data_pdfs_20_314_10[ctr_0]);
          const __m256d xi_69 = _mm256_load_pd(&_data_pdfs_20_35_10[ctr_0]);
          const __m256d xi_70 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
          const __m256d xi_71 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
          const __m256d xi_72 = _mm256_load_pd(&_data_velocity_20_31_10[ctr_0]);
          const __m256d xi_73 = _mm256_load_pd(&_data_pdfs_20_33_10[ctr_0]);
          const __m256d xi_74 = _mm256_load_pd(&_data_velocity_20_32_10[ctr_0]);
          const __m256d xi_75 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
          const __m256d xi_76 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          const __m256d xi_77 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
          const __m256d xi_78 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
          const __m256d xi_79 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
          const __m256d xi_80 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
          const __m256d xi_81 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
          const __m256d xi_82 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
          const __m256d xi_83 = _mm256_load_pd(&_data_pdfs_20_317_10[ctr_0]);
          const __m256d xi_84 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
          const __m256d xi_85 = _mm256_load_pd(&_data_force_20_31_10[ctr_0]);
          const __m256d xi_86 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
          const __m256d xi_87 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
          const __m256d xi_3 = _mm256_mul_pd(xi_72, xi_85);
          const __m256d xi_4 = _mm256_mul_pd(xi_74, xi_81);
          const __m256d xi_5 =
              _mm256_mul_pd(xi_72, _mm256_set_pd(2.0, 2.0, 2.0, 2.0));
          const __m256d xi_6 =
              _mm256_add_pd(xi_5, _mm256_set_pd(1.0, 1.0, 1.0, 1.0));
          const __m256d xi_7 = _mm256_mul_pd(
              xi_85, _mm256_set_pd(0.166666666666667, 0.166666666666667,
          ...
          const __m256d xi_14 = _mm256_mul_pd(
              xi_65, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                   0.166666666666667, 0.166666666666667));
          ...
          const __m256d xi_18 =
              _mm256_mul_pd(xi_74, _mm256_set_pd(2.0, 2.0, 2.0, 2.0));
          const __m256d xi_19 =
              _mm256_add_pd(xi_18, _mm256_set_pd(1.0, 1.0, 1.0, 1.0));
          const __m256d xi_20 = _mm256_mul_pd(
              xi_81, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                   0.166666666666667, 0.166666666666667));
          const __m256d xi_22 =
              _mm256_add_pd(xi_18, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
          ...
          const __m256d xi_24 =
              _mm256_mul_pd(xi_72, _mm256_set_pd(3.0, 3.0, 3.0, 3.0));
          const __m256d xi_26 = _mm256_mul_pd(
              xi_65, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                   0.0833333333333333, 0.0833333333333333));
          const __m256d xi_29 = _mm256_mul_pd(
              xi_85, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                   0.0833333333333333, 0.0833333333333333));
          const __m256d xi_30 =
          ...
          const __m256d xi_33 =
              _mm256_mul_pd(xi_74, _mm256_set_pd(3.0, 3.0, 3.0, 3.0));
          const __m256d xi_34 = _mm256_mul_pd(
              xi_81, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                   0.0833333333333333, 0.0833333333333333));
          ...
          const __m256d xi_39 = (_mm256_mul_pd(xi_72, xi_72));
          const __m256d xi_41 = (_mm256_mul_pd(xi_74, xi_74));
          ...
          const __m256d xi_48 = _mm256_mul_pd(
              xi_74, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                   0.166666666666667, 0.166666666666667));
          const __m256d xi_49 =
          ...
          const __m256d u_0 = _mm256_add_pd(
              xi_63, _mm256_set_pd(
                         ...
                         ((points_down && ctr_1 <= 0)
                              ...
                              : ((points_up && ctr_1 >= 63) ? (-1.0) : (0.0))) *
                             0.050000000000000003));
          const __m256d xi_2 = _mm256_mul_pd(u_0, xi_65);
          ...
          const __m256d u0Mu1 = _mm256_add_pd(
              _mm256_mul_pd(xi_72, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), u_0);
          ...
          const __m256d u0Pu1 = _mm256_add_pd(u_0, xi_72);
          ...
          const __m256d xi_54 =
              _mm256_mul_pd((_mm256_mul_pd(u0Pu1, u0Pu1)),
                            _mm256_set_pd(0.125, 0.125, 0.125, 0.125));
          const __m256d u1Pu2 = _mm256_add_pd(xi_72, xi_74);
          ...
          const __m256d xi_56 =
              _mm256_mul_pd((_mm256_mul_pd(u1Pu2, u1Pu2)),
                            _mm256_set_pd(0.125, 0.125, 0.125, 0.125));
          const __m256d u1Mu2 = _mm256_add_pd(xi_38, xi_72);
          ...
          const __m256d xi_60 =
              _mm256_mul_pd((_mm256_mul_pd(u0Mu2, u0Mu2)),
                            _mm256_set_pd(0.125, 0.125, 0.125, 0.125));
          const __m256d u0Pu2 = _mm256_add_pd(u_0, xi_74);
                          ...
                          _mm256_add_pd(
                              _mm256_mul_pd(f_eq_common,
                                            _mm256_set_pd(0.333333333333333,
                                                          ...
                                                          0.333333333333333,
                                                          0.333333333333333)),
                              _mm256_mul_pd(xi_80, _mm256_set_pd(-1.0, -1.0,
                                                                 -1.0, -1.0))),
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_63 = _data_velocity_20_30_10[ctr_0];
          const double xi_64 = _data_pdfs_20_31_10[ctr_0];
          const double xi_65 = _data_force_20_30_10[ctr_0];
          const double xi_66 = _data_pdfs_20_39_10[ctr_0];
          const double xi_67 = _data_pdfs_20_36_10[ctr_0];
          const double xi_68 = _data_pdfs_20_314_10[ctr_0];
          const double xi_69 = _data_pdfs_20_35_10[ctr_0];
          const double xi_70 = _data_pdfs_20_310_10[ctr_0];
          const double xi_71 = _data_pdfs_20_311_10[ctr_0];
          const double xi_72 = _data_velocity_20_31_10[ctr_0];
          const double xi_73 = _data_pdfs_20_33_10[ctr_0];
          const double xi_74 = _data_velocity_20_32_10[ctr_0];
          const double xi_75 = _data_pdfs_20_318_10[ctr_0];
          const double xi_76 = _data_pdfs_20_316_10[ctr_0];
          const double xi_77 = _data_pdfs_20_312_10[ctr_0];
          const double xi_78 = _data_pdfs_20_38_10[ctr_0];
          const double xi_79 = _data_pdfs_20_32_10[ctr_0];
          const double xi_80 = _data_pdfs_20_30_10[ctr_0];
          const double xi_81 = _data_force_20_32_10[ctr_0];
          const double xi_82 = _data_pdfs_20_313_10[ctr_0];
          const double xi_83 = _data_pdfs_20_317_10[ctr_0];
          const double xi_84 = _data_pdfs_20_34_10[ctr_0];
          const double xi_85 = _data_force_20_31_10[ctr_0];
          const double xi_86 = _data_pdfs_20_37_10[ctr_0];
          const double xi_87 = _data_pdfs_20_315_10[ctr_0];
          const double xi_3 = xi_72 * xi_85;
          const double xi_4 = xi_74 * xi_81;
          const double xi_5 = xi_72 * 2.0;
          const double xi_6 = xi_5 + 1.0;
          const double xi_7 = xi_85 * 0.166666666666667;
          const double xi_9 = xi_4 * -0.166666666666667;
          const double xi_11 = xi_5 - 1.0;
          const double xi_14 = xi_65 * 0.166666666666667;
          const double xi_15 = xi_3 * -0.166666666666667;
          const double xi_16 = xi_15 + xi_9;
          const double xi_18 = xi_74 * 2.0;
          const double xi_19 = xi_18 + 1.0;
          const double xi_20 = xi_81 * 0.166666666666667;
          const double xi_22 = xi_18 - 1.0;
          const double xi_23 = xi_4 * -0.0833333333333333;
          const double xi_24 = xi_72 * 3.0;
          const double xi_26 = xi_65 * 0.0833333333333333;
          const double xi_29 = xi_85 * 0.0833333333333333;
          const double xi_30 = -xi_24;
          const double xi_31 = -xi_5 + 1.0;
          const double xi_33 = xi_74 * 3.0;
          const double xi_34 = xi_81 * 0.0833333333333333;
          const double xi_35 = xi_3 * -0.0833333333333333;
          const double xi_36 = -xi_33;
          const double xi_37 = -xi_18 + 1.0;
          const double xi_38 = -xi_74;
          const double xi_39 = (xi_72 * xi_72);
          const double xi_41 = (xi_74 * xi_74);
          const double xi_44 = xi_72 * 0.166666666666667;
          const double xi_45 = xi_39 * 0.25;
          const double xi_48 = xi_74 * 0.166666666666667;
          const double xi_49 = xi_41 * 0.25;
          const double rho = xi_64 + xi_66 + xi_67 + xi_68 + xi_69 + xi_70 +
                             xi_71 + xi_73 + xi_75 + xi_76 + xi_77 + xi_78 +
                             xi_79 + xi_80 + xi_82 + xi_83 + xi_84 + xi_86 +
                             xi_87;
          const double xi_40 = rho * 1.5;
          const double u_0 =
              xi_63 + ((points_down && ctr_1 <= 0)
                           ? (1.0)
                           : ((points_up && ctr_1 >= 63) ? (-1.0) : (0.0))) *
                          0.050000000000000003;
          const double xi_2 = u_0 * xi_65;
          ...
          _data_pdfs_20_30_10[ctr_0] =
              forceTerm_0 +
              omega_bulk * (f_eq_common * 0.333333333333333 - xi_80) + xi_80;
          _data_pdfs_20_31_10[ctr_0] =
              forceTerm_1 +
              omega_bulk * (rho * (xi_44 + xi_45) + xi_43 - xi_64) + xi_64;
          _data_pdfs_20_32_10[ctr_0] =
              forceTerm_2 +
              omega_bulk * (rho * (-xi_44 + xi_45) + xi_43 - xi_79) + xi_79;
          _data_pdfs_20_33_10[ctr_0] =
              forceTerm_3 +
              omega_bulk * (rho * (-xi_46 + xi_47) + xi_43 - xi_73) + xi_73;
          _data_pdfs_20_34_10[ctr_0] =
              forceTerm_4 +
              omega_bulk * (rho * (xi_46 + xi_47) + xi_43 - xi_84) + xi_84;
          _data_pdfs_20_35_10[ctr_0] =
              forceTerm_5 +
              omega_bulk * (rho * (xi_48 + xi_49) + xi_43 - xi_69) + xi_69;
          _data_pdfs_20_36_10[ctr_0] =
              forceTerm_6 +
              omega_bulk * (rho * (-xi_48 + xi_49) + xi_43 - xi_67) + xi_67;
          _data_pdfs_20_37_10[ctr_0] =
              forceTerm_7 +
              omega_bulk * (rho * (-xi_51 + xi_52) + xi_50 - xi_86) + xi_86;
          _data_pdfs_20_38_10[ctr_0] =
              forceTerm_8 +
          ...
          _data_pdfs_20_312_10[ctr_0] =
              forceTerm_12 +
              omega_bulk * (rho * (-xi_57 + xi_58) + xi_50 - xi_77) + xi_77;
          _data_pdfs_20_313_10[ctr_0] =
              forceTerm_13 +
              omega_bulk * (rho * (-xi_59 + xi_60) + xi_50 - xi_82) + xi_82;
          _data_pdfs_20_314_10[ctr_0] =
              forceTerm_14 +
              omega_bulk * (rho * (xi_61 + xi_62) + xi_50 - xi_68) + xi_68;
          _data_pdfs_20_315_10[ctr_0] =
              forceTerm_15 +
              omega_bulk * (rho * (xi_57 + xi_58) + xi_50 - xi_87) + xi_87;
          _data_pdfs_20_316_10[ctr_0] =
              forceTerm_16 +
              omega_bulk * (rho * (-xi_55 + xi_56) + xi_50 - xi_76) + xi_76;
          _data_pdfs_20_317_10[ctr_0] =
              forceTerm_17 +
              omega_bulk * (rho * (-xi_61 + xi_62) + xi_50 - xi_83) + xi_83;
          _data_pdfs_20_318_10[ctr_0] =
              forceTerm_18 +
