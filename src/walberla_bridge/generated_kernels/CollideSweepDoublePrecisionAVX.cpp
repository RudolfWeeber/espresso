    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_315;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const __m256d xi_225 = _mm256_load_pd(&_data_pdfs_20_36_10[ctr_0]);
          const __m256d xi_226 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
          const __m256d xi_227 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
          ...
          const __m256d xi_230 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          const __m256d xi_231 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
          const __m256d xi_232 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
          const __m256d xi_233 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
          const __m256d xi_234 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
          ...
          const __m256d xi_237 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
          const __m256d xi_238 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
          const __m256d xi_239 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
          const __m256d xi_240 = _mm256_load_pd(&_data_force_20_31_10[ctr_0]);
          const __m256d xi_241 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
          const __m256d xi_0 = _mm256_add_pd(xi_221, xi_229);
          const __m256d xi_1 = _mm256_add_pd(xi_0, xi_238);
          const __m256d xi_2 =
              _mm256_add_pd(_mm256_add_pd(xi_220, xi_227), xi_241);
          const __m256d xi_3 = _mm256_add_pd(xi_222, xi_231);
          const __m256d xi_4 = _mm256_add_pd(xi_223, xi_224);
          const __m256d xi_5 = _mm256_add_pd(xi_230, xi_233);
          const __m256d xi_6 = _mm256_add_pd(xi_225, xi_236);
          const __m256d xi_9 =
          ...
          const __m256d xi_25 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(xi_18, xi_227), xi_23), xi_24);
          ...
          const __m256d xi_51 = _mm256_mul_pd(
              xi_235, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_68 =
              _mm256_mul_pd(xi_240, _mm256_set_pd(0.25, 0.25, 0.25, 0.25));
          const __m256d xi_73 =
              _mm256_mul_pd(xi_240, _mm256_set_pd(xi_72, xi_72, xi_72, xi_72));
          ...
          const __m256d xi_107 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  _mm256_mul_pd(xi_225, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))),
              xi_106);
                          ...
                          _mm256_add_pd(
                              _mm256_add_pd(
                                  _mm256_add_pd(
                                      ...
                                      _mm256_mul_pd(xi_227,
                                                    _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0))),
                                  _mm256_mul_pd(
                                      xi_230,
                                      _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                              _mm256_mul_pd(xi_231, _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0))),
          ...
          const __m256d xi_109 = _mm256_add_pd(
              ...
              _mm256_mul_pd(xi_241, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)));
                  ...
                  _mm256_add_pd(
                      _mm256_add_pd(
                          _mm256_add_pd(
                              ...
                              _mm256_mul_pd(xi_236, _mm256_set_pd(-5.0, -5.0,
                                                                  -5.0, -5.0))),
          ...
          const __m256d xi_125 = _mm256_mul_pd(
              _mm256_add_pd(
                  ...
                  xi_124),
              _mm256_set_pd(omega_even, omega_even, omega_even, omega_even));
          const __m256d xi_126 = _mm256_add_pd(xi_114, xi_231);
          const __m256d xi_127 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_126, xi_15), xi_220),
                            xi_23),
              xi_230);
          ...
          const __m256d xi_138 = _mm256_add_pd(xi_116, xi_226);
          const __m256d xi_142 = _mm256_add_pd(xi_236, xi_239);
          ...
          const __m256d xi_154 = _mm256_add_pd(xi_119, xi_239);
          ...
          const __m256d xi_161 = _mm256_add_pd(xi_230, xi_241);
          ...
          const __m256d vel0Term =
              _mm256_add_pd(_mm256_add_pd(xi_1, xi_226), xi_232);
          const __m256d vel1Term = _mm256_add_pd(xi_2, xi_237);
          const __m256d vel2Term = _mm256_add_pd(xi_239, xi_3);
          ...
          const __m256d xi_27 = _mm256_mul_pd(u_1, xi_240);
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_220 = _data_pdfs_20_31_10[ctr_0];
          ...
          const double xi_225 = _data_pdfs_20_36_10[ctr_0];
          const double xi_226 = _data_pdfs_20_310_10[ctr_0];
          const double xi_227 = _data_pdfs_20_311_10[ctr_0];
          const double xi_228 = _data_force_20_30_10[ctr_0];
          const double xi_229 = _data_pdfs_20_318_10[ctr_0];
          const double xi_230 = _data_pdfs_20_316_10[ctr_0];
          const double xi_231 = _data_pdfs_20_312_10[ctr_0];
          const double xi_232 = _data_pdfs_20_38_10[ctr_0];
          const double xi_233 = _data_pdfs_20_32_10[ctr_0];
          const double xi_234 = _data_pdfs_20_30_10[ctr_0];
          const double xi_235 = _data_force_20_32_10[ctr_0];
          const double xi_236 = _data_pdfs_20_317_10[ctr_0];
          const double xi_237 = _data_pdfs_20_37_10[ctr_0];
          const double xi_238 = _data_pdfs_20_34_10[ctr_0];
          const double xi_239 = _data_pdfs_20_313_10[ctr_0];
          const double xi_240 = _data_force_20_31_10[ctr_0];
          const double xi_241 = _data_pdfs_20_315_10[ctr_0];
          const double xi_0 = xi_221 + xi_229;
          const double xi_1 = xi_0 + xi_238;
          const double xi_2 = xi_220 + xi_227 + xi_241;
          const double xi_3 = xi_222 + xi_231;
          const double xi_4 = xi_223 + xi_224;
          const double xi_5 = xi_230 + xi_233;
          const double xi_6 = xi_225 + xi_236;
          const double xi_9 = -xi_223;
          const double xi_10 = -xi_237 + xi_9;
          const double xi_11 = -xi_236;
          const double xi_12 = -xi_239;
          const double xi_13 = -xi_224;
          const double xi_14 = xi_11 + xi_12 + xi_13;
          const double xi_15 = -xi_233;
          const double xi_16 = -xi_226;
          const double xi_17 = xi_15 + xi_16;
          const double xi_18 = -xi_230;
          const double xi_19 = -xi_231;
          const double xi_20 = xi_18 + xi_19;
          const double xi_21 = -xi_229;
          const double xi_22 = xi_11 + xi_21;
          const double xi_23 = -xi_241;
          const double xi_24 = -xi_225;
          const double xi_25 = xi_18 + xi_227 + xi_23 + xi_24;
          const double xi_30 = xi_240 * 0.166666666666667;
          const double xi_31 = xi_240 * 0.0833333333333333;
          ...
          const double xi_68 = xi_240 * 0.25;
          const double xi_73 = xi_240 * xi_72;
          const double xi_106 = -xi_234;
          const double xi_107 = xi_106 + xi_222 * 3.0 + xi_225 * 3.0;
          const double xi_108 =
              omega_even *
              (xi_107 + xi_220 * 3.0 + xi_227 * -3.0 + xi_230 * -3.0 +
               xi_231 * -3.0 + xi_233 * 3.0 + xi_241 * -3.0);
          const double xi_109 =
              xi_227 * 2.0 + xi_230 * 2.0 + xi_231 * 2.0 + xi_241 * 2.0;
          const double xi_110 = xi_109 + xi_224 * 5.0 + xi_238 * 5.0;
          const double xi_111 =
              omega_even *
              (xi_107 + xi_110 + xi_220 * -2.0 + xi_221 * -5.0 + xi_229 * -5.0 +
               xi_233 * -2.0 + xi_236 * -5.0 + xi_239 * -5.0);
          const double xi_114 = -xi_227;
          const double xi_115 = xi_114 + xi_19;
          const double xi_116 = -xi_232;
          ...
          const double xi_124 = xi_229 * 2.0 + xi_236 * 2.0;
          const double xi_125 =
              omega_even *
              (xi_106 + xi_110 + xi_122 + xi_123 + xi_124 + xi_220 * 5.0 +
               xi_222 * -4.0 + xi_223 * -7.0 + xi_225 * -4.0 + xi_226 * -7.0 +
               xi_232 * -7.0 + xi_233 * 5.0 + xi_237 * -7.0);
          const double xi_126 = xi_114 + xi_231;
          const double xi_127 = xi_126 + xi_15 + xi_220 + xi_23 + xi_230;
          const double xi_129 = xi_127 * xi_128;
          const double xi_130 = xi_237 * 2.0;
          ...
          const double xi_142 = xi_236 + xi_239;
          const double xi_146 = xi_125 * -0.0198412698412698;
          const double xi_154 = xi_119 + xi_239;
          const double xi_155 = xi_13 + xi_154 + xi_21 + xi_236 + xi_238;
          ...
          const double xi_161 = xi_230 + xi_241;
          ...
          const double xi_60 = xi_240 * xi_54;
          const double xi_82 = xi_235 * xi_54;
          const double vel0Term = xi_1 + xi_226 + xi_232;
          const double vel1Term = xi_2 + xi_237;
          const double vel2Term = xi_239 + xi_3;
          const double rho =
              vel0Term + vel1Term + vel2Term + xi_234 + xi_4 + xi_5 + xi_6;
          ...
          const double xi_152 = -vel0Term + xi_142 + xi_151 + xi_237 + xi_4;
          const double xi_153 = xi_140 * xi_152;
          const double xi_180 = xi_152 * xi_176;
          const double u_1 =
              xi_240 * xi_8 + xi_7 * (vel1Term + xi_17 + xi_20 + xi_232 + xi_9);
          const double xi_27 = u_1 * xi_240;
          ...
          const double xi_139 =
              -vel1Term + xi_137 + xi_138 + xi_223 + xi_231 + xi_5;
          const double xi_141 = xi_139 * xi_140;
          const double xi_172 =
              xi_171 * (u_0 * xi_137 + xi_138 + xi_237 + xi_9);
          ...
          const double xi_121 =
              omega_bulk * (xi_112 + xi_113 + xi_115 + xi_118 + xi_120 + xi_18 +
                            xi_23 + xi_234);
          const double xi_143 = -xi_113 + xi_222 + xi_225;
          const double xi_144 =
          ...
          const double xi_147 =
              ...
              (xi_10 + xi_109 + xi_112 * 2.0 + xi_116 - xi_117 + xi_120 +
               xi_143 + xi_220 + xi_224 * -2.0 + xi_233 + xi_238 * -2.0);
          ...
          const double xi_191 =
              xi_171 * (u_2 * xi_137 + xi_126 + xi_18 + xi_241);
          ...
          _data_pdfs_20_30_10[ctr_0] =
              ...
              xi_121 * -0.5 + xi_125 * 0.0238095238095238 + xi_234;
          _data_pdfs_20_31_10[ctr_0] =
              forceTerm_1 - xi_129 + xi_136 + xi_141 + xi_150 + xi_220;
          _data_pdfs_20_32_10[ctr_0] =
              forceTerm_2 + xi_129 + xi_135 - xi_141 + xi_150 + xi_233;
          _data_pdfs_20_33_10[ctr_0] =
              forceTerm_3 - xi_153 + xi_156 + xi_158 + xi_159 + xi_224;
          _data_pdfs_20_34_10[ctr_0] =
              forceTerm_4 + xi_153 - xi_156 + xi_159 + xi_160 + xi_238;
          _data_pdfs_20_35_10[ctr_0] =
              forceTerm_5 - xi_163 + xi_165 + xi_168 + xi_169 + xi_222;
          _data_pdfs_20_36_10[ctr_0] =
              forceTerm_6 + xi_163 - xi_165 + xi_169 + xi_170 + xi_225;
          _data_pdfs_20_37_10[ctr_0] =
              forceTerm_7 + xi_175 + xi_179 + xi_184 + xi_237;
          _data_pdfs_20_38_10[ctr_0] =
              forceTerm_8 + xi_179 + xi_185 + xi_187 + xi_232;
          _data_pdfs_20_39_10[ctr_0] =
          ...
          _data_pdfs_20_312_10[ctr_0] =
              forceTerm_12 + xi_201 + xi_205 + xi_206 + xi_231;
          _data_pdfs_20_313_10[ctr_0] =
              forceTerm_13 + xi_210 + xi_211 + xi_214 + xi_239;
          _data_pdfs_20_314_10[ctr_0] =
              forceTerm_14 + xi_211 + xi_215 + xi_216 + xi_221;
          _data_pdfs_20_315_10[ctr_0] =
              forceTerm_15 + xi_204 + xi_206 + xi_218 + xi_241;
          _data_pdfs_20_316_10[ctr_0] =
              forceTerm_16 + xi_193 + xi_205 + xi_218 + xi_230;
          _data_pdfs_20_317_10[ctr_0] =
