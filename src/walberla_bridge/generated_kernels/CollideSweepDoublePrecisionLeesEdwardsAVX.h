...
{
public:
    CollideSweepDoublePrecisionLeesEdwardsAVX( BlockDataID forceID_, BlockDataID pdfsID_, BlockDataID velocityID_, double omega_bulk, bool points_down, bool points_up )
        : forceID(forceID_), pdfsID(pdfsID_), velocityID(velocityID_), omega_bulk_(omega_bulk), points_down_(points_down), points_up_(points_up)
    {};
