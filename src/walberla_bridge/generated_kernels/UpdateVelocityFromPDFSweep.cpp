...
//
//! \\file UpdateVelocityFromPDFSweep.cpp
//! \\ingroup lbm
//! \\author lbmpy
//======================================================================================================================
...
#include "UpdateVelocityFromPDFSweep.h"
...
namespace internal_updatevelocityfrompdfsweep_updatevelocityfrompdfsweep {
static FUNC_PREFIX void updatevelocityfrompdfsweep_updatevelocityfrompdfsweep(
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const double vel0Term = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0] +
        ...
        const double vel1Term = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0] +
        ...
        const double vel2Term = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] +
        ...
        const double u_0 =
            (vel0Term - _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] -
             _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0] -
             _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0] -
             _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0] -
             _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0]) /
...
void UpdateVelocityFromPDFSweep::run(IBlock *block) {
  ...
  internal_updatevelocityfrompdfsweep_updatevelocityfrompdfsweep::
      updatevelocityfrompdfsweep_updatevelocityfrompdfsweep(
...
void UpdateVelocityFromPDFSweep::runOnCellInterval(
