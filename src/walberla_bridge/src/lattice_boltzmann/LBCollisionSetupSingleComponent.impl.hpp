...
FloatType LBWalberlaImplSingleComponent<FloatType, Architecture>::
...
template <typename FloatType, lbmpy::Arch Architecture>
FloatType LBWalberlaImplSingleComponent<FloatType, Architecture>::
    odd_mode_relaxation_rate(FloatType shear_relaxation,
                             FloatType magic_number) const {
 ...
 */
template <typename FloatType, lbmpy::Arch Architecture>
void LBWalberlaImplSingleComponent<
    FloatType, Architecture>::set_collision_model(double kT,
                                                  unsigned int seed) {
...
void LBWalberlaImplSingleComponent<FloatType, Architecture>::
  ...
  m_lees_edwards_pdf_interpol_sweep =
      std::make_shared<InterpolateAndShiftAtBoundary<_PdfField, FloatType>>(
          blocks, m_pdf_field_id[0], m_pdf_tmp_field_id[0], n_ghost_layers,
...
template <typename FloatType, lbmpy::Arch Architecture>
void LBWalberlaImplSingleComponent<FloatType, Architecture>::check_lebc(
