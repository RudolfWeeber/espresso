...
//
//! \\file CollideSweepDoublePrecisionLeesEdwardsThermalizedAVX.h
//! \\author pystencils
//======================================================================================================================
...
class CollideSweepDoublePrecisionLeesEdwardsThermalizedAVX {
public:
  CollideSweepDoublePrecisionLeesEdwardsThermalizedAVX(
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<CollideSweepDoublePrecisionLeesEdwardsThermalizedAVX>
          &kernel) {
