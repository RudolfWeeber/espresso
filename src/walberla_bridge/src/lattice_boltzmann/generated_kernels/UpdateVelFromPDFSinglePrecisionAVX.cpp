...
updatevelfrompdfsingleprecisionavx_updatevelfrompdfsingleprecisionavx(
    float *RESTRICT const _data_force, float *RESTRICT const _data_pdfs,
    float *RESTRICT _data_velocity, int64_t const _size_force_0,
      ...
      for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
        {
          for (int64_t ctr_0 = 1;
            ...
            _mm256_store_ps(&_data_velocity[_stride_velocity_1 * ctr_1 +
                                            _stride_velocity_2 * ctr_2 + ctr_0],
                            u_0);
            _mm256_storeu_ps(&_data_velocity[_stride_velocity_1 * ctr_1 +
                                             _stride_velocity_2 * ctr_2 +
                                             _stride_velocity_3 + ctr_0],
                             u_1);
            _mm256_storeu_ps(&_data_velocity[_stride_velocity_1 * ctr_1 +
                                             _stride_velocity_2 * ctr_2 +
                                             2 * _stride_velocity_3 + ctr_0],
                             u_2);
          }
          for (int64_t ctr_0 = (int64_t)((_size_force_0 - 2) / (8)) * (8) + 1;
            ...
            const float u_0 = momdensity_0 * ((1.0f) / (rho)) +
                              0.5f * ((1.0f) / (rho)) *
                                  _data_force[_stride_force_1 * ctr_1 +
                                              _stride_force_2 * ctr_2 + ctr_0];
            const float u_1 = momdensity_1 * ((1.0f) / (rho)) +
                              0.5f * ((1.0f) / (rho)) *
                                  _data_force[_stride_force_1 * ctr_1 +
                                              _stride_force_2 * ctr_2 +
                                              _stride_force_3 + ctr_0];
            const float u_2 = momdensity_2 * ((1.0f) / (rho)) +
                              0.5f * ((1.0f) / (rho)) *
                                  _data_force[_stride_force_1 * ctr_1 +
                                              _stride_force_2 * ctr_2 +
                                              2 * _stride_force_3 + ctr_0];
            _data_velocity[_stride_velocity_1 * ctr_1 +
                           _stride_velocity_2 * ctr_2 + ctr_0] = u_0;
            _data_velocity[_stride_velocity_1 * ctr_1 +
...
void UpdateVelFromPDFSinglePrecisionAVX::run(IBlock *block) {
  ...
  internal_9f3cf46adc24d4ebfb8e08168d5e7562::
      updatevelfrompdfsingleprecisionavx_updatevelfrompdfsingleprecisionavx(
...
void UpdateVelFromPDFSinglePrecisionAVX::runOnCellInterval(
