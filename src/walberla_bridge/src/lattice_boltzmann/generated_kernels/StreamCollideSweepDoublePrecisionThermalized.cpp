...
//
//! \\file StreamCollideSweepDoublePrecisionThermalized.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "StreamCollideSweepDoublePrecisionThermalized.h"
...
namespace internal_bdc99b91ffd091fa865a4ccd734ba062 {
static FUNC_PREFIX void
streamcollidesweepdoubleprecisionthermalized_streamcollidesweepdoubleprecisionthermalized(
    ...
    for (int64_t ctr_2 = 1; ctr_2 < _size_force_2 - 1; ctr_2 += 1) {
      for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
        for (int64_t ctr_0 = 1; ctr_0 < _size_force_0 - 1; ctr_0 += 1) {
          ...
          const double xi_134 =
              pow(xi_95 * (1.0 - ((-omega_shear + 1.0) * (-omega_shear + 1.0))),
                  0.5);
          ...
          const double u_0 = xi_0 * (vel0Term - xi_11 - xi_8) +
          ...
          const double xi_37 =
              ...
              _data_force[_stride_force_0 * ctr_0 + _stride_force_1 * ctr_1 +
                          _stride_force_2 * ctr_2 + 2 * _stride_force_3];
          const double xi_38 = omega_shear * xi_28 +
          ...
          _data_pdfs_tmp[_stride_pdfs_tmp_0 * ctr_0 +
              ...
              xi_132 + xi_134 * xi_173 * xi_174 * 0.33333333333333331 - xi_183 -
              xi_184 - xi_189 - xi_195;
          _data_pdfs_tmp[_stride_pdfs_tmp_0 * ctr_0 +
                         _stride_pdfs_tmp_1 * ctr_1 +
...
void StreamCollideSweepDoublePrecisionThermalized::run(IBlock *block) {
  if (!this->configured_)
  ...
  internal_bdc99b91ffd091fa865a4ccd734ba062::
      streamcollidesweepdoubleprecisionthermalized_streamcollidesweepdoubleprecisionthermalized(
...
void StreamCollideSweepDoublePrecisionThermalized::runOnCellInterval(
