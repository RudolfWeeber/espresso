...
//
//! \\file CollideSweepSinglePrecisionLeesEdwardsThermalized.h
//! \\author pystencils
//======================================================================================================================
...
class CollideSweepSinglePrecisionLeesEdwardsThermalized {
public:
  CollideSweepSinglePrecisionLeesEdwardsThermalized(
      BlockDataID forceID_, BlockDataID pdfsID_, uint32_t block_offset_0,
      uint32_t block_offset_1, uint32_t block_offset_2, float grid_size,
      float kT, float omega_bulk, float omega_even, float omega_odd,
      float omega_shear, uint32_t seed, uint32_t time_step, float v_s)
  ...
  getSweep(const shared_ptr<CollideSweepSinglePrecisionLeesEdwardsThermalized>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<CollideSweepSinglePrecisionLeesEdwardsThermalized>
          &kernel,
