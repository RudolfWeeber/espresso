    ...
    for (int64_t ctr_1 = 1; ctr_1 < _size_pdfs_1 - 1; ctr_1 += 1) {
      {
        ...
        for (int64_t ctr_0 = (int64_t)((_size_pdfs_0 - 2) / (8)) * (8) + 1; ctr_0 < _size_pdfs_0 - 1; ctr_0 += 1) {
...
void StreamSweepSinglePrecisionAVX::run(IBlock *block) {
  ...
  internal_5e7ed0276adbfbb1ac4789ac0a0f54c4::streamsweepsingleprecisionavx_streamsweepsingleprecisionavx(_data_pdfs, _data_pdfs_tmp, _size_pdfs_0, _size_pdfs_1, _size_pdfs_2, _stride_pdfs_1, _stride_pdfs_2, _stride_pdfs_3, _stride_pdfs_tmp_1, _stride_pdfs_tmp_2, _stride_pdfs_tmp_3);
