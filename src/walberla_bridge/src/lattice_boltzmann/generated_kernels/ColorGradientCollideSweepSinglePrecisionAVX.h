...
//
//! \\file ColorGradientCollideSweepSinglePrecisionAVX.h
//! \\author pystencils
//======================================================================================================================
...
public:
   ...
   static std::function<void (IBlock *)> getSweep(const shared_ptr<ColorGradientCollideSweepSinglePrecisionAVX> & kernel)
   {
     return [kernel]
            (IBlock * b)
            { kernel->run(b); };
   ...
   static std::function<void (IBlock*)> getSweepOnCellInterval(const shared_ptr<ColorGradientCollideSweepSinglePrecisionAVX> & kernel, const shared_ptr<StructuredBlockStorage> & blocks, const CellInterval & globalCellInterval, cell_idx_t ghostLayers=1)
   {
