...
//
//! \\file CollideSweepSinglePrecisionLeesEdwardsThermalizedAVX.h
//! \\author pystencils
//======================================================================================================================
...
class CollideSweepSinglePrecisionLeesEdwardsThermalizedAVX {
public:
  CollideSweepSinglePrecisionLeesEdwardsThermalizedAVX(
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<CollideSweepSinglePrecisionLeesEdwardsThermalizedAVX>
          &kernel) {
