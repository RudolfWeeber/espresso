...
static FUNC_PREFIX
__launch_bounds__(256) void streamcollidesweepsingleprecisionthermalizedcuda_streamcollidesweepsingleprecisionthermalizedcuda(
...
void StreamCollideSweepSinglePrecisionThermalizedCUDA::run(IBlock *block,
                                                           gpuStream_t stream) {
  if (!this->configured_)
...
void StreamCollideSweepSinglePrecisionThermalizedCUDA::runOnCellInterval(
