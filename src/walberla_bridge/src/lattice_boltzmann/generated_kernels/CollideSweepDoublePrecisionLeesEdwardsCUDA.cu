...
static FUNC_PREFIX __launch_bounds__(256) void collidesweepdoubleprecisionleesedwardscuda_collidesweepdoubleprecisionleesedwardscuda(double * RESTRICT const _data_force, double * RESTRICT  _data_pdfs, int64_t const _size_force_0, int64_t const _size_force_1, int64_t const _size_force_2, int64_t const _stride_force_0, int64_t const _stride_force_1, int64_t const _stride_force_2, int64_t const _stride_force_3, int64_t const _stride_pdfs_0, int64_t const _stride_pdfs_1, int64_t const _stride_pdfs_2, int64_t const _stride_pdfs_3, double grid_size, double omega_bulk, double omega_even, double omega_odd, double omega_shear, double rho, double v_s)
{
   if (blockDim.x*blockIdx.x + threadIdx.x < _size_force_0 && blockDim.y*blockIdx.y + threadIdx.y < _size_force_1 && blockDim.z*blockIdx.z + threadIdx.z < _size_force_2)
   {
      ...
      const double xi_45 = _data_force[_stride_force_0*ctr_0 + _stride_force_1*ctr_1 + _stride_force_2*ctr_2];
      const double xi_46 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 11*_stride_pdfs_3];
      const double xi_47 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2];
      const double xi_48 = _data_force[_stride_force_0*ctr_0 + _stride_force_1*ctr_1 + _stride_force_2*ctr_2 + _stride_force_3];
      const double xi_49 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 4*_stride_pdfs_3];
      const double xi_50 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + _stride_pdfs_3];
      const double xi_51 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 7*_stride_pdfs_3];
      const double xi_52 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 14*_stride_pdfs_3];
      const double xi_53 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 8*_stride_pdfs_3];
      const double xi_54 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 5*_stride_pdfs_3];
      const double xi_55 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 12*_stride_pdfs_3];
      const double xi_56 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 3*_stride_pdfs_3];
      const double xi_57 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 6*_stride_pdfs_3];
      const double xi_58 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 13*_stride_pdfs_3];
      const double xi_59 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 18*_stride_pdfs_3];
      const double xi_60 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 17*_stride_pdfs_3];
      const double xi_61 = _data_force[_stride_force_0*ctr_0 + _stride_force_1*ctr_1 + _stride_force_2*ctr_2 + 2*_stride_force_3];
      const double xi_62 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 2*_stride_pdfs_3];
      const double xi_63 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 16*_stride_pdfs_3];
      const double xi_64 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 15*_stride_pdfs_3];
      const double xi_65 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 9*_stride_pdfs_3];
      const double xi_66 = _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_2*ctr_2 + 10*_stride_pdfs_3];
      const double xi_23 = xi_48;
      const double xi_24 = xi_62;
      const double xi_25 = xi_55;
      const double xi_26 = xi_46;
      const double xi_27 = xi_61;
      const double xi_28 = xi_50;
      const double xi_29 = xi_56;
      const double xi_30 = xi_65;
      const double xi_31 = xi_59;
      const double xi_32 = xi_53;
      const double xi_33 = xi_66;
      const double xi_34 = xi_47;
      const double xi_35 = xi_54;
      const double xi_36 = xi_57;
      const double xi_37 = xi_60;
      const double xi_38 = xi_51;
      const double xi_39 = xi_45;
      const double xi_40 = xi_63;
      const double xi_41 = xi_49;
      const double xi_42 = xi_58;
      const double xi_43 = xi_64;
      const double xi_44 = xi_52;
...
void CollideSweepDoublePrecisionLeesEdwardsCUDA::run(IBlock * block, gpuStream_t stream)
{
    ...
    internal_collidesweepdoubleprecisionleesedwardscuda_collidesweepdoubleprecisionleesedwardscuda::collidesweepdoubleprecisionleesedwardscuda_collidesweepdoubleprecisionleesedwardscuda<<<_grid, _block, 0, stream>>>(_data_force, _data_pdfs, _size_force_0, _size_force_1, _size_force_2, _stride_force_0, _stride_force_1, _stride_force_2, _stride_force_3, _stride_pdfs_0, _stride_pdfs_1, _stride_pdfs_2, _stride_pdfs_3, grid_size, omega_bulk, omega_even, omega_odd, omega_shear, rho, v_s);
