...
streamcollidesweepdoubleprecisionleesedwardsavx_streamcollidesweepdoubleprecisionleesedwardsavx(
                        ...
                        _mm256_add_pd(
                            _mm256_add_pd(
                                ...
                                _mm256_mul_pd(
                                    ...
                                    _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))),
                            _mm256_mul_pd(
                                xi_261, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))),
                        _mm256_blendv_pd(
                            _mm256_set_pd(0.0, 0.0, 0.0, 0.0),
                            _mm256_mul_pd(
                                _mm256_mul_pd(
                                    ...
                                    _mm256_set_pd(0.083333333333333329,
                                                  ...
                                                  0.083333333333333329)),
                                _mm256_set_pd(v_s, v_s, v_s, v_s)),
                            _mm256_cmp_pd(_mm256_set_pd(((double)(ctr_1)),
                                                        ((double)(ctr_1)),
                                                        ((double)(ctr_1)),
                                                        ((double)(ctr_1))),
                                          _mm256_set_pd(grid_size, grid_size,
...
void StreamCollideSweepDoublePrecisionLeesEdwardsAVX::run(IBlock *block) {
  ...
  internal_7a9c3e1332986727943ef5a2aa109600::
      streamcollidesweepdoubleprecisionleesedwardsavx_streamcollidesweepdoubleprecisionleesedwardsavx(
...
void StreamCollideSweepDoublePrecisionLeesEdwardsAVX::runOnCellInterval(
