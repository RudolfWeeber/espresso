...
//
//! \\file CollideSweepDoublePrecisionLeesEdwardsThermalized.h
//! \\author pystencils
//======================================================================================================================
...
class CollideSweepDoublePrecisionLeesEdwardsThermalized {
public:
  CollideSweepDoublePrecisionLeesEdwardsThermalized(
  ...
  getSweep(const shared_ptr<CollideSweepDoublePrecisionLeesEdwardsThermalized>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<CollideSweepDoublePrecisionLeesEdwardsThermalized>
          &kernel,
