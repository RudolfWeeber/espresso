...
//
//! \\file StreamCollideSweepSinglePrecisionThermalizedAVX.h
//! \\author pystencils
//======================================================================================================================
...
class StreamCollideSweepSinglePrecisionThermalizedAVX {
public:
  StreamCollideSweepSinglePrecisionThermalizedAVX(
  ...
  getSweep(const shared_ptr<StreamCollideSweepSinglePrecisionThermalizedAVX>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<StreamCollideSweepSinglePrecisionThermalizedAVX> &kernel,
