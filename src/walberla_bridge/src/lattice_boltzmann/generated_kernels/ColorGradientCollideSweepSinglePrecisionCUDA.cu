...
static FUNC_PREFIX __launch_bounds__(256) void colorgradientcollidesweepsingleprecisioncuda_colorgradientcollidesweepsingleprecisioncuda(float * RESTRICT const _data_color_gradient, float * RESTRICT const _data_force_a, float * RESTRICT const _data_force_b, float * RESTRICT  _data_pdfs_a, float * RESTRICT  _data_pdfs_b, float * RESTRICT const _data_phasefield, float * RESTRICT const _data_rho_a, float * RESTRICT const _data_rho_b, float * RESTRICT const _data_velocity, int64_t const _size_color_gradient_0, int64_t const _size_color_gradient_1, int64_t const _size_color_gradient_2, int64_t const _stride_color_gradient_0, int64_t const _stride_color_gradient_1, int64_t const _stride_color_gradient_2, int64_t const _stride_color_gradient_3, int64_t const _stride_force_a_0, int64_t const _stride_force_a_1, int64_t const _stride_force_a_2, int64_t const _stride_force_a_3, int64_t const _stride_force_b_0, int64_t const _stride_force_b_1, int64_t const _stride_force_b_2, int64_t const _stride_force_b_3, int64_t const _stride_pdfs_a_0, int64_t const _stride_pdfs_a_1, int64_t const _stride_pdfs_a_2, int64_t const _stride_pdfs_a_3, int64_t const _stride_pdfs_b_0, int64_t const _stride_pdfs_b_1, int64_t const _stride_pdfs_b_2, int64_t const _stride_pdfs_b_3, int64_t const _stride_phasefield_0, int64_t const _stride_phasefield_1, int64_t const _stride_phasefield_2, int64_t const _stride_rho_a_0, int64_t const _stride_rho_a_1, int64_t const _stride_rho_a_2, int64_t const _stride_rho_b_0, int64_t const _stride_rho_b_1, int64_t const _stride_rho_b_2, int64_t const _stride_velocity_0, int64_t const _stride_velocity_1, int64_t const _stride_velocity_2, int64_t const _stride_velocity_3, float beta, float omega_even_a, float omega_even_b, float omega_odd_a, float omega_odd_b, float omega_shear_a, float omega_shear_b, float sigma)
{
   if (blockDim.x*blockIdx.x + threadIdx.x < _size_color_gradient_0 && blockDim.y*blockIdx.y + threadIdx.y < _size_color_gradient_1 && blockDim.z*blockIdx.z + threadIdx.z < _size_color_gradient_2)
   {
      ...
      const float xia_2_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2];
      ...
      const float xia_4_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 9*_stride_pdfs_a_3];
      ...
      const float xia_6_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3];
      const float xi_26 = xia_6_collide*0.16666666666666666f;
      const float xi_28 = omega_odd_a*xi_26;
      const float xi_55 = xia_6_collide*0.083333333333333329f;
      const float xi_56 = xi_33*xia_6_collide;
      ...
      const float xia_9_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      ...
      const float xia_12_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 3*_stride_pdfs_a_3];
      const float xia_13_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2];
      const float xi_17 = xia_13_collide*0.16666666666666666f;
      const float xi_18 = omega_odd_a*xi_17;
      const float xi_32 = xia_13_collide*0.083333333333333329f;
      const float xi_34 = xi_33*xia_13_collide;
      const float xi_35 = xi_32 - xi_34;
      const float xi_51 = -xi_32 + xi_34;
      const float xia_14_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 8*_stride_pdfs_a_3];
      const float xi_201 = -xia_14_collide;
      const float xi_202 = xi_201 + xia_4_collide;
      ...
      const float xia_16_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 10*_stride_pdfs_a_3];
      const float xia_17_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3];
      const float xia_18_collide = _data_rho_a[_stride_rho_a_0*ctr_0 + _stride_rho_a_1*ctr_1 + _stride_rho_a_2*ctr_2];
      const float xia_19_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 14*_stride_pdfs_a_3];
      const float xi_175 = xi_174 + xia_19_collide + xia_8_collide;
      const float xi_220 = -xia_19_collide;
      const float xi_221 = xi_220 + xia_8_collide;
      const float xia_20_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 11*_stride_pdfs_a_3];
      const float xi_206 = -xia_20_collide;
      const float xia_21_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + _stride_force_a_3];
      const float xi_4 = xia_21_collide*0.16666666666666666f;
      const float xi_7 = omega_odd_a*xi_4;
      const float xi_37 = xia_21_collide*0.083333333333333329f;
      const float xi_38 = xi_33*xia_21_collide;
      const float xi_39 = -xi_37 + xi_38;
      const float xi_41 = xia_21_collide*0.25f;
      const float xi_46 = xi_45*xia_21_collide;
      ...
      const float xi_170 = xia_22_collide + xia_5_collide;
      const float xia_23_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 7*_stride_pdfs_a_3];
      const float xi_177 = xia_16_collide + xia_23_collide;
      const float xi_178 = xi_177 + xia_14_collide + xia_4_collide;
      const float xia_24_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_3];
      const float xia_25_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 16*_stride_pdfs_a_3];
      const float xi_171 = xi_170 + xia_20_collide + xia_25_collide;
      const float xi_207 = xi_206 + xia_25_collide;
      const float xia_26_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 6*_stride_pdfs_a_3];
      const float rr_0_a_collide = 0.0f;
      const float xi_5 = rr_0_a_collide*0.25f;
      const float xi_6 = xi_5*xia_21_collide;
      const float xi_19 = xi_5*xia_13_collide;
      const float xi_27 = xi_5*xia_6_collide;
      const float rho_a_collide = xia_18_collide;
      const float xi_164 = rho_a_collide*-0.1111111111111111f;
      const float xi_180 = rho_a_collide*-0.33333333333333331f;
      const float xi_182 = xi_171 + xi_180;
      const float xi_199 = rho_a_collide*0.33333333333333331f;
      const float u_0_a_collide = xia_9_collide;
      const float xi_0 = u_0_a_collide*xia_13_collide;
      ...
      const float xi_73 = u_0_a_collide*xia_6_collide;
      ...
      const float xi_181 = omega_shear_a*(rho_a_collide*xi_169 - xi_175 - xi_178 - xi_180 - xia_12_collide - xia_15_collide);
      const float xi_217 = u_0_a_collide*xi_199;
      const float xi_218 = xi_202 + xi_217 - xia_16_collide + xia_23_collide;
      const float xi_219 = xi_204*xi_218;
      const float xi_222 = xi_217 + xi_221 - xia_1_collide + xia_7_collide;
      ...
      const float u_1_a_collide = xia_17_collide;
      const float xi_1 = u_1_a_collide*xia_21_collide;
      ...
      const float xi_44 = xi_43*xia_13_collide;
      const float xi_48 = u_1_a_collide*xi_45;
      const float xi_49 = xi_48*xia_13_collide;
      const float xi_50 = xi_42 + xi_44 - xi_47 - xi_49;
      const float xi_52 = -xi_42 - xi_44 + xi_47 + xi_49;
      const float xi_59 = -xi_23;
      const float xi_63 = xi_43*xia_6_collide;
      const float xi_65 = xi_48*xia_6_collide;
      const float xi_71 = omega_even_a*u_1_a_collide*xia_21_collide*-0.041666666666666664f;
      const float xi_165 = u_1_a_collide*u_1_a_collide;
      const float xi_166 = rho_a_collide*xi_165*-0.33333333333333331f;
      const float xi_183 = omega_shear_a*(rho_a_collide*xi_165 - xi_178 - xi_182 - xia_10_collide - xia_24_collide);
      const float xi_200 = u_1_a_collide*xi_199;
      const float xi_203 = xi_200 + xi_202 + xia_16_collide - xia_23_collide;
      const float xi_205 = xi_203*xi_204;
      const float xi_208 = xi_200 + xi_207 - xia_22_collide + xia_5_collide;
      const float xi_209 = xi_204*xi_208;
      const float xi_237 = rho_a_collide*u_1_a_collide;
      const float xi_239 = xi_238*(u_0_a_collide*xi_237 + xi_177 + xi_201 - xia_4_collide);
      ...
      const float xi_2 = u_2_a_collide*xia_6_collide;
      ...
      const float xi_36 = omega_even_a*u_2_a_collide*xia_6_collide*-0.041666666666666664f;
      ...
      const float xi_75 = u_2_a_collide*xia_13_collide;
      ...
      const float xi_184 = omega_shear_a*(rho_a_collide*xi_167 - xi_175 - xi_182 - xia_11_collide - xia_26_collide);
      ...
      const float xi_226 = xi_181*0.5f + xi_210 + xi_224 + xi_225;
      const float xi_227 = u_2_a_collide*xi_199;
      const float xi_228 = xi_221 + xi_227 + xia_1_collide - xia_7_collide;
      const float xi_229 = xi_204*xi_228;
      const float xi_230 = xi_207 + xi_227 + xia_22_collide - xia_5_collide;
      ...
      const float xi_253 = xi_238*(u_2_a_collide*xi_237 + xi_170 + xi_206 - xia_25_collide);
      const float xi_256 = xi_172*0.25f;
      const float xi_257 = xi_230*xi_234;
      const float xi_258 = xi_256 + xi_257;
      const float xi_260 = -xi_253;
      const float xi_266 = xi_238*(rho_a_collide*u_0_a_collide*u_2_a_collide + xi_174 + xi_220 - xia_8_collide);
      const float xi_267 = -xi_266;
      const float xi_270 = xi_176*0.25f;
      const float xi_271 = xi_228*xi_234;
      const float xi_272 = xi_270 + xi_271;
      const float xi_276 = xi_256 - xi_257;
      const float xi_279 = xi_270 - xi_271;
      const float forceTerm_0_a_collide = omega_shear_a*u_0_a_collide*xia_13_collide + omega_shear_a*u_1_a_collide*xia_21_collide + omega_shear_a*u_2_a_collide*xia_6_collide - xi_0*xi_3 - xi_0 - xi_1*xi_3 - xi_1 - xi_2*xi_3 - xi_2;
      ...
      const float xib_1_collide = _data_rho_b[_stride_rho_b_0*ctr_0 + _stride_rho_b_1*ctr_1 + _stride_rho_b_2*ctr_2];
      const float xib_2_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 5*_stride_pdfs_b_3];
      const float xib_3_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2];
      const float xi_99 = xib_3_collide*0.16666666666666666f;
      const float xi_100 = omega_odd_b*xi_99;
      const float xi_114 = xib_3_collide*0.083333333333333329f;
      const float xi_116 = xi_115*xib_3_collide;
      ...
      const float xib_7_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 11*_stride_pdfs_b_3];
      const float xi_304 = -xib_7_collide;
      ...
      const float xib_10_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 13*_stride_pdfs_b_3];
      const float xi_291 = xib_10_collide + xib_9_collide;
      const float xib_11_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      ...
      const float xi_317 = -xib_12_collide;
      ...
      const float xib_14_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_3];
      const float xib_15_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + 2*_stride_force_b_3];
      const float xi_108 = xib_15_collide*0.16666666666666666f;
      const float xi_110 = omega_odd_b*xi_108;
      const float xi_137 = xib_15_collide*0.083333333333333329f;
      const float xi_138 = xi_115*xib_15_collide;
      const float xi_139 = xi_137 - xi_138;
      const float xi_152 = -xi_137 + xi_138;
      const float xib_16_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 12*_stride_pdfs_b_3];
      const float xib_17_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3];
      const float xib_18_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 17*_stride_pdfs_b_3];
      const float xi_292 = xi_291 + xib_12_collide + xib_18_collide;
      const float xi_318 = xi_317 + xib_18_collide;
      const float xib_19_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3];
      const float xib_20_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 2*_stride_pdfs_b_3];
      const float xib_21_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 16*_stride_pdfs_b_3];
      const float xi_305 = xi_304 + xib_21_collide;
      const float xib_22_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 15*_stride_pdfs_b_3];
      const float xi_287 = xib_16_collide + xib_22_collide;
      const float xi_288 = xi_287 + xib_21_collide + xib_7_collide;
      const float xib_23_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + _stride_force_b_3];
      const float xi_86 = xib_23_collide*0.16666666666666666f;
      const float xi_89 = omega_odd_b*xi_86;
      const float xi_119 = xib_23_collide*0.083333333333333329f;
      const float xi_120 = xi_115*xib_23_collide;
      const float xi_121 = -xi_119 + xi_120;
      const float xi_123 = xib_23_collide*0.25f;
      const float xi_128 = xi_127*xib_23_collide;
      const float xi_135 = xi_119 - xi_120;
      const float xib_24_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3];
      const float xi_309 = -xib_24_collide;
      const float xi_310 = xi_309 + xib_6_collide;
      const float xib_25_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 7*_stride_pdfs_b_3];
      const float xi_294 = xib_25_collide + xib_5_collide;
      const float xi_295 = xi_294 + xib_24_collide + xib_6_collide;
      const float xib_26_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 6*_stride_pdfs_b_3];
      const float rr_0_b_collide = 0.0f;
      const float xi_87 = rr_0_b_collide*0.25f;
      const float xi_88 = xi_87*xib_23_collide;
      const float xi_101 = xi_87*xib_3_collide;
      const float xi_109 = xi_87*xib_15_collide;
      const float rho_b_collide = xib_1_collide;
      const float xi_284 = rho_b_collide*-0.1111111111111111f;
      const float xi_297 = rho_b_collide*-0.33333333333333331f;
      const float xi_298 = xi_292 + xi_297;
      const float xi_302 = rho_b_collide*0.33333333333333331f;
      const float u_0_b_collide = xib_11_collide;
      const float xi_82 = u_0_b_collide*xib_3_collide;
      ...
      const float xi_155 = u_0_b_collide*xib_15_collide;
      ...
      const float xi_299 = omega_shear_b*(rho_b_collide*xi_283 - xi_295 - xi_298 - xib_13_collide - xib_19_collide);
      const float xi_316 = u_0_b_collide*xi_302;
      const float xi_319 = xi_316 + xi_318 + xib_10_collide - xib_9_collide;
      const float xi_320 = xi_307*xi_319;
      const float xi_321 = xi_310 + xi_316 + xib_25_collide - xib_5_collide;
      const float xi_322 = xi_307*xi_321;
      const float xi_332 = xi_321*xi_331;
      const float xi_333 = -xi_332;
      const float xi_349 = xi_319*xi_331;
      const float xi_350 = -xi_349;
      const float u_1_b_collide = xib_17_collide;
      const float xi_83 = u_1_b_collide*xib_23_collide;
      ...
      const float xi_126 = xi_125*xib_3_collide;
      const float xi_130 = u_1_b_collide*xi_127;
      const float xi_131 = xi_130*xib_3_collide;
      const float xi_132 = xi_124 + xi_126 - xi_129 - xi_131;
      const float xi_134 = -xi_124 - xi_126 + xi_129 + xi_131;
      const float xi_141 = -xi_105;
      const float xi_145 = xi_125*xib_15_collide;
      const float xi_147 = xi_130*xib_15_collide;
      const float xi_153 = omega_even_b*u_1_b_collide*xib_23_collide*-0.041666666666666664f;
      const float xi_281 = u_1_b_collide*u_1_b_collide;
      const float xi_282 = rho_b_collide*xi_281*-0.33333333333333331f;
      const float xi_300 = omega_shear_b*(rho_b_collide*xi_281 - xi_288 - xi_295 - xi_297 - xib_14_collide - xib_20_collide);
      const float xi_303 = u_1_b_collide*xi_302;
      const float xi_306 = xi_303 + xi_305 + xib_16_collide - xib_22_collide;
      const float xi_308 = xi_306*xi_307;
      const float xi_311 = xi_303 + xi_310 - xib_25_collide + xib_5_collide;
      const float xi_312 = xi_307*xi_311;
      const float xi_334 = rho_b_collide*u_1_b_collide;
      const float xi_336 = xi_335*(u_0_b_collide*xi_334 + xi_294 + xi_309 - xib_6_collide);
      ...
      const float xi_84 = u_2_b_collide*xib_15_collide;
      ...
      const float xi_118 = omega_even_b*u_2_b_collide*xib_15_collide*-0.041666666666666664f;
      ...
      const float xi_157 = u_2_b_collide*xib_3_collide;
      ...
      const float xi_285 = u_2_b_collide*u_2_b_collide;
      ...
      const float xi_293 = omega_even_b*(rho_b_collide*xi_281*-0.16666666666666666f - xi_286 - xi_290 - xi_292);
      const float xi_296 = omega_even_b*(rho_b_collide*xi_285*-0.16666666666666666f - xi_282 - xi_284 - xi_290 - xi_295);
      const float xi_301 = omega_shear_b*(rho_b_collide*xi_285 - xi_288 - xi_298 - xib_26_collide - xib_2_collide);
      const float xi_313 = xi_289*-0.5f;
      const float xi_314 = xi_296*-0.5f;
      const float xi_315 = xi_215 + xi_300*0.5f + xi_313 + xi_314;
      const float xi_323 = xi_293*-0.5f;
      const float xi_324 = xi_225 + xi_299*0.5f + xi_314 + xi_323;
      const float xi_325 = u_2_b_collide*xi_302;
      const float xi_326 = xi_318 + xi_325 - xib_10_collide + xib_9_collide;
      const float xi_327 = xi_307*xi_326;
      const float xi_328 = xi_305 + xi_325 - xib_16_collide + xib_22_collide;
      const float xi_329 = xi_307*xi_328;
      const float xi_330 = xi_232 + xi_301*0.5f + xi_313 + xi_323;
      const float xi_338 = xi_296*0.25f;
      const float xi_340 = xi_338 + xi_339;
      const float xi_341 = xi_338 - xi_339;
      const float xi_343 = xi_335*(u_2_b_collide*xi_334 + xi_287 + xi_304 - xib_21_collide);
      const float xi_344 = xi_289*0.25f;
      const float xi_345 = xi_328*xi_331;
      const float xi_346 = xi_344 + xi_345;
      const float xi_348 = -xi_343;
      const float xi_351 = xi_335*(rho_b_collide*u_0_b_collide*u_2_b_collide + xi_291 + xi_317 - xib_18_collide);
      const float xi_352 = -xi_351;
      const float xi_353 = xi_293*0.25f;
      const float xi_354 = xi_326*xi_331;
      const float xi_355 = xi_353 + xi_354;
      const float xi_356 = xi_344 - xi_345;
      const float xi_357 = xi_353 - xi_354;
      const float forceTerm_0_b_collide = omega_shear_b*u_0_b_collide*xib_3_collide + omega_shear_b*u_1_b_collide*xib_23_collide + omega_shear_b*u_2_b_collide*xib_15_collide - xi_82*xi_85 - xi_82 - xi_83*xi_85 - xi_83 - xi_84*xi_85 - xi_84;
      ...
      const float tmp_a0 = forceTerm_0_a_collide + xi_172 + xi_176 + xi_179 - xi_181 - xi_183 - xi_184 + xi_198 + xia_2_collide;
      const float tmp_a1 = forceTerm_1_a_collide - xi_205 - xi_209 + xi_216 + xia_24_collide;
      const float tmp_a2 = forceTerm_2_a_collide + xi_205 + xi_209 + xi_216 + xia_10_collide;
      const float tmp_a3 = forceTerm_3_a_collide + xi_219 + xi_223 + xi_226 + xia_12_collide;
      const float tmp_a4 = forceTerm_4_a_collide - xi_219 - xi_223 + xi_226 + xia_15_collide;
      const float tmp_a5 = forceTerm_5_a_collide - xi_229 - xi_231 + xi_233 + xia_11_collide;
      const float tmp_a6 = forceTerm_6_a_collide + xi_229 + xi_231 + xi_233 + xia_26_collide;
      const float tmp_a7 = forceTerm_7_a_collide + xi_236 + xi_240 + xi_243 + xi_246 + xia_23_collide;
      const float tmp_a8 = forceTerm_8_a_collide + xi_235 + xi_239 + xi_246 + xi_248 + xia_14_collide;
      const float tmp_a9 = forceTerm_9_a_collide + xi_236 + xi_239 + xi_249 + xi_250 + xia_4_collide;
      const float tmp_a10 = forceTerm_10_a_collide + xi_235 + xi_240 + xi_250 + xi_251 + xia_16_collide;
      const float tmp_a11 = forceTerm_11_a_collide + xi_252 + xi_253 + xi_255 + xi_258 + xia_20_collide;
      const float tmp_a12 = forceTerm_12_a_collide + xi_258 + xi_259 + xi_260 + xi_263 + xia_5_collide;
      const float tmp_a13 = forceTerm_13_a_collide + xi_265 + xi_267 + xi_269 + xi_272 + xia_7_collide;
      const float tmp_a14 = forceTerm_14_a_collide + xi_264 + xi_266 + xi_272 + xi_274 + xia_19_collide;
      const float tmp_a15 = forceTerm_15_a_collide + xi_252 + xi_260 + xi_275 + xi_276 + xia_22_collide;
      const float tmp_a16 = forceTerm_16_a_collide + xi_253 + xi_259 + xi_276 + xi_277 + xia_25_collide;
      const float tmp_a17 = forceTerm_17_a_collide + xi_265 + xi_266 + xi_278 + xi_279 + xia_8_collide;
      const float tmp_a18 = forceTerm_18_a_collide + xi_264 + xi_267 + xi_279 + xi_280 + xia_1_collide;
      const float tmp_b0 = forceTerm_0_b_collide + xi_198 + xi_289 + xi_293 + xi_296 - xi_299 - xi_300 - xi_301 + xib_8_collide;
      const float tmp_b1 = forceTerm_1_b_collide - xi_308 - xi_312 + xi_315 + xib_14_collide;
      const float tmp_b2 = forceTerm_2_b_collide + xi_308 + xi_312 + xi_315 + xib_20_collide;
      const float tmp_b3 = forceTerm_3_b_collide + xi_320 + xi_322 + xi_324 + xib_19_collide;
      const float tmp_b4 = forceTerm_4_b_collide - xi_320 - xi_322 + xi_324 + xib_13_collide;
      const float tmp_b5 = forceTerm_5_b_collide - xi_327 - xi_329 + xi_330 + xib_2_collide;
      const float tmp_b6 = forceTerm_6_b_collide + xi_327 + xi_329 + xi_330 + xib_26_collide;
      const float tmp_b7 = forceTerm_7_b_collide + xi_243 + xi_333 + xi_337 + xi_340 + xib_25_collide;
      const float tmp_b8 = forceTerm_8_b_collide + xi_248 + xi_332 + xi_336 + xi_340 + xib_24_collide;
      const float tmp_b9 = forceTerm_9_b_collide + xi_249 + xi_333 + xi_336 + xi_341 + xib_6_collide;
      const float tmp_b10 = forceTerm_10_b_collide + xi_251 + xi_332 + xi_337 + xi_341 + xib_5_collide;
      const float tmp_b11 = forceTerm_11_b_collide + xi_255 + xi_342 + xi_343 + xi_346 + xib_7_collide;
      const float tmp_b12 = forceTerm_12_b_collide + xi_263 + xi_346 + xi_347 + xi_348 + xib_16_collide;
      const float tmp_b13 = forceTerm_13_b_collide + xi_269 + xi_350 + xi_352 + xi_355 + xib_10_collide;
      const float tmp_b14 = forceTerm_14_b_collide + xi_274 + xi_349 + xi_351 + xi_355 + xib_12_collide;
      const float tmp_b15 = forceTerm_15_b_collide + xi_275 + xi_342 + xi_348 + xi_356 + xib_22_collide;
      const float tmp_b16 = forceTerm_16_b_collide + xi_277 + xi_343 + xi_347 + xi_356 + xib_21_collide;
      const float tmp_b17 = forceTerm_17_b_collide + xi_278 + xi_350 + xi_351 + xi_357 + xib_18_collide;
      const float tmp_b18 = forceTerm_18_b_collide + xi_280 + xi_349 + xi_352 + xi_357 + xib_9_collide;
...
void ColorGradientCollideSweepSinglePrecisionCUDA::run(IBlock * block, gpuStream_t stream)
{
    ...
    auto color_gradient = block->getData< gpu::GPUField<float> >(color_gradientID);
