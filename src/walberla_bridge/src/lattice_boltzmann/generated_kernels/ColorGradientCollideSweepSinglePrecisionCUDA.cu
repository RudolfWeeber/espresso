...
static FUNC_PREFIX __launch_bounds__(256) void colorgradientcollidesweepsingleprecisioncuda_colorgradientcollidesweepsingleprecisioncuda(float * RESTRICT const _data_force_a, float * RESTRICT const _data_force_b, float * RESTRICT  _data_pdfs_a, float * RESTRICT  _data_pdfs_b, float * RESTRICT const _data_phasefield, float * RESTRICT const _data_rho_a, float * RESTRICT const _data_rho_b, float * RESTRICT const _data_velocity, int64_t const _size_force_a_0, int64_t const _size_force_a_1, int64_t const _size_force_a_2, int64_t const _stride_force_a_0, int64_t const _stride_force_a_1, int64_t const _stride_force_a_2, int64_t const _stride_force_a_3, int64_t const _stride_force_b_0, int64_t const _stride_force_b_1, int64_t const _stride_force_b_2, int64_t const _stride_force_b_3, int64_t const _stride_pdfs_a_0, int64_t const _stride_pdfs_a_1, int64_t const _stride_pdfs_a_2, int64_t const _stride_pdfs_a_3, int64_t const _stride_pdfs_b_0, int64_t const _stride_pdfs_b_1, int64_t const _stride_pdfs_b_2, int64_t const _stride_pdfs_b_3, int64_t const _stride_phasefield_0, int64_t const _stride_phasefield_1, int64_t const _stride_phasefield_2, int64_t const _stride_rho_a_0, int64_t const _stride_rho_a_1, int64_t const _stride_rho_a_2, int64_t const _stride_rho_b_0, int64_t const _stride_rho_b_1, int64_t const _stride_rho_b_2, int64_t const _stride_velocity_0, int64_t const _stride_velocity_1, int64_t const _stride_velocity_2, int64_t const _stride_velocity_3, float beta, float omega_even_a, float omega_even_b, float omega_odd_a, float omega_odd_b, float omega_shear_a, float omega_shear_b, float sigma)
{
   if (blockDim.x*blockIdx.x + threadIdx.x + 1 < _size_force_a_0 - 1 && blockDim.y*blockIdx.y + threadIdx.y + 1 < _size_force_a_1 - 1 && blockDim.z*blockIdx.z + threadIdx.z + 1 < _size_force_a_2 - 1)
   {
      ...
      const float xia_1_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 18*_stride_pdfs_a_3];
      const float xia_2_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 10*_stride_pdfs_a_3];
      ...
      const float xia_4_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2];
      const float xia_5_collide = _data_rho_a[_stride_rho_a_0*ctr_0 + _stride_rho_a_1*ctr_1 + _stride_rho_a_2*ctr_2];
      const float xia_6_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      const float xia_7_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 13*_stride_pdfs_a_3];
      const float xi_174 = xia_1_collide + xia_7_collide;
      ...
      const float xia_9_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 3*_stride_pdfs_a_3];
      const float xia_10_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + _stride_force_a_3];
      const float xi_4 = xia_10_collide*0.16666666666666666f;
      const float xi_7 = omega_odd_a*xi_4;
      const float xi_37 = xia_10_collide*0.083333333333333329f;
      const float xi_38 = xi_33*xia_10_collide;
      const float xi_39 = -xi_37 + xi_38;
      const float xi_41 = xia_10_collide*0.25f;
      const float xi_46 = xi_45*xia_10_collide;
      const float xi_53 = xi_37 - xi_38;
      const float xia_11_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3];
      const float xia_12_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 7*_stride_pdfs_a_3];
      const float xi_177 = xia_12_collide + xia_2_collide;
      const float xia_13_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 12*_stride_pdfs_a_3];
      const float xia_14_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 14*_stride_pdfs_a_3];
      const float xi_175 = xi_174 + xia_14_collide + xia_8_collide;
      const float xi_267 = -xia_14_collide;
      const float xi_268 = xi_267 + xia_8_collide;
      const float xia_15_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_3];
      const float xia_16_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3];
      const float xi_26 = xia_16_collide*0.16666666666666666f;
      const float xi_28 = omega_odd_a*xi_26;
      const float xi_55 = xia_16_collide*0.083333333333333329f;
      const float xi_56 = xi_33*xia_16_collide;
      ...
      const float xia_18_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 5*_stride_pdfs_a_3];
      const float xia_19_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 11*_stride_pdfs_a_3];
      const float xi_248 = -xia_19_collide;
      const float xia_20_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 8*_stride_pdfs_a_3];
      const float xi_253 = -xia_20_collide;
      const float xia_21_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 2*_stride_pdfs_a_3];
      const float xia_22_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 15*_stride_pdfs_a_3];
      const float xi_170 = xia_13_collide + xia_22_collide;
      const float xia_23_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 9*_stride_pdfs_a_3];
      const float xi_178 = xi_177 + xia_20_collide + xia_23_collide;
      const float xi_254 = xi_253 + xia_23_collide;
      ...
      const float xi_171 = xi_170 + xia_19_collide + xia_24_collide;
      const float xi_249 = xi_248 + xia_24_collide;
      const float xia_25_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 6*_stride_pdfs_a_3];
      const float xia_26_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2];
      const float xi_17 = xia_26_collide*0.16666666666666666f;
      const float xi_18 = omega_odd_a*xi_17;
      const float xi_32 = xia_26_collide*0.083333333333333329f;
      const float xi_34 = xi_33*xia_26_collide;
      ...
      const float xi_6 = xi_5*xia_10_collide;
      const float xi_19 = xi_5*xia_26_collide;
      const float xi_27 = xi_5*xia_16_collide;
      const float rho_a_collide = xia_5_collide;
      ...
      const float xi_0 = u_0_a_collide*xia_26_collide;
      ...
      const float xi_73 = u_0_a_collide*xia_16_collide;
      ...
      const float xi_182 = omega_shear_a*(rho_a_collide*xi_166 - xi_175 - xi_181 - xia_17_collide - xia_9_collide);
      const float xi_264 = u_0_a_collide*xi_246;
      const float xi_265 = xi_254 + xi_264 + xia_12_collide - xia_2_collide;
      const float xi_266 = xi_251*xi_265;
      const float xi_269 = xi_264 + xi_268 - xia_1_collide + xia_7_collide;
      const float xi_270 = xi_251*xi_269;
      const float xi_284 = xi_265*xi_283;
      const float xi_285 = -xi_284;
      const float xi_327 = xi_269*xi_283;
      const float xi_328 = -xi_327;
      const float u_1_a_collide = xia_3_collide;
      const float xi_1 = u_1_a_collide*xia_10_collide;
      ...
      const float xi_44 = xi_43*xia_26_collide;
      const float xi_48 = u_1_a_collide*xi_45;
      const float xi_49 = xi_48*xia_26_collide;
      const float xi_50 = xi_42 + xi_44 - xi_47 - xi_49;
      const float xi_52 = -xi_42 - xi_44 + xi_47 + xi_49;
      const float xi_59 = -xi_23;
      const float xi_63 = xi_43*xia_16_collide;
      const float xi_65 = xi_48*xia_16_collide;
      const float xi_71 = omega_even_a*u_1_a_collide*xia_10_collide*-0.041666666666666664f;
      const float xi_168 = u_1_a_collide*u_1_a_collide;
      const float xi_169 = rho_a_collide*xi_168*-0.33333333333333331f + xi_167;
      const float xi_183 = omega_shear_a*(rho_a_collide*xi_168 - xi_171 - xi_181 - xia_15_collide - xia_21_collide);
      const float xi_247 = u_1_a_collide*xi_246;
      const float xi_250 = xi_247 + xi_249 + xia_13_collide - xia_22_collide;
      const float xi_252 = xi_250*xi_251;
      const float xi_255 = xi_247 + xi_254 - xia_12_collide + xia_2_collide;
      const float xi_256 = xi_251*xi_255;
      const float xi_286 = rho_a_collide*u_1_a_collide;
      const float xi_288 = xi_287*(u_0_a_collide*xi_286 + xi_177 + xi_253 - xia_23_collide);
      const float xi_289 = -xi_288;
      const float xi_300 = xi_255*xi_283;
      const float xi_311 = xi_250*xi_283;
      const float xi_321 = -xi_311;
      const float u_2_a_collide = xia_11_collide;
      const float xi_2 = u_2_a_collide*xia_16_collide;
      ...
      const float xi_36 = omega_even_a*u_2_a_collide*xia_16_collide*-0.041666666666666664f;
      ...
      const float xi_75 = u_2_a_collide*xia_26_collide;
      ...
      const float xi_184 = omega_shear_a*(rho_a_collide*xi_164 - xi_171 - xi_175 - xi_180 - xia_18_collide - xia_25_collide);
      ...
      const float xi_276 = xi_268 + xi_275 + xia_1_collide - xia_7_collide;
      const float xi_277 = xi_251*xi_276;
      const float xi_278 = xi_249 + xi_275 - xia_13_collide + xia_22_collide;
      ...
      const float xi_312 = xi_287*(u_2_a_collide*xi_286 + xi_170 + xi_248 - xia_24_collide);
      const float xi_318 = xi_172*0.25f;
      const float xi_319 = xi_278*xi_283;
      const float xi_320 = xi_318 + xi_319;
      const float xi_322 = -xi_312;
      const float xi_329 = xi_287*(rho_a_collide*u_0_a_collide*u_2_a_collide + xi_174 + xi_267 - xia_8_collide);
      const float xi_330 = -xi_329;
      const float xi_334 = xi_176*0.25f;
      const float xi_335 = xi_276*xi_283;
      const float xi_336 = xi_334 + xi_335;
      const float xi_341 = xi_318 - xi_319;
      const float xi_344 = xi_334 - xi_335;
      const float forceTerm_0_a_collide = omega_shear_a*u_0_a_collide*xia_26_collide + omega_shear_a*u_1_a_collide*xia_10_collide + omega_shear_a*u_2_a_collide*xia_16_collide - xi_0*xi_3 - xi_0 - xi_1*xi_3 - xi_1 - xi_2*xi_3 - xi_2;
      ...
      const float xib_1_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 12*_stride_pdfs_b_3];
      const float xib_2_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3];
      const float xib_3_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3];
      const float xib_4_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 17*_stride_pdfs_b_3];
      const float xib_5_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 11*_stride_pdfs_b_3];
      const float xi_369 = -xib_5_collide;
      const float xib_6_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 7*_stride_pdfs_b_3];
      const float xib_7_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 5*_stride_pdfs_b_3];
      const float xib_8_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      const float xib_9_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 14*_stride_pdfs_b_3];
      const float xi_384 = -xib_9_collide;
      const float xi_385 = xi_384 + xib_4_collide;
      ...
      const float xib_11_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 9*_stride_pdfs_b_3];
      ...
      const float xib_13_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 2*_stride_pdfs_b_3];
      const float xib_14_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + 2*_stride_force_b_3];
      ...
      const float xib_15_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 10*_stride_pdfs_b_3];
      const float xi_359 = xib_15_collide + xib_6_collide;
      const float xib_16_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3];
      const float xib_17_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 18*_stride_pdfs_b_3];
      const float xi_356 = xib_12_collide + xib_17_collide;
      const float xi_357 = xi_356 + xib_4_collide + xib_9_collide;
      const float xib_18_collide = _data_rho_b[_stride_rho_b_0*ctr_0 + _stride_rho_b_1*ctr_1 + _stride_rho_b_2*ctr_2];
      const float xib_19_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3];
      const float xi_360 = xi_359 + xib_11_collide + xib_19_collide;
      const float xi_374 = -xib_19_collide;
      const float xi_375 = xi_374 + xib_11_collide;
      const float xib_20_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 4*_stride_pdfs_b_3];
      ...
      const float xi_352 = xib_1_collide + xib_21_collide;
      const float xi_353 = xi_352 + xib_10_collide + xib_5_collide;
      const float xib_22_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + _stride_force_b_3];
      const float xi_86 = xib_22_collide*0.16666666666666666f;
      const float xi_89 = omega_odd_b*xi_86;
      const float xi_119 = xib_22_collide*0.083333333333333329f;
      const float xi_120 = xi_115*xib_22_collide;
      const float xi_121 = -xi_119 + xi_120;
      const float xi_123 = xib_22_collide*0.25f;
      const float xi_128 = xi_127*xib_22_collide;
      const float xi_135 = xi_119 - xi_120;
      const float xib_23_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 6*_stride_pdfs_b_3];
      const float xib_24_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2];
      const float xi_99 = xib_24_collide*0.16666666666666666f;
      const float xi_100 = omega_odd_b*xi_99;
      const float xi_114 = xib_24_collide*0.083333333333333329f;
      const float xi_116 = xi_115*xib_24_collide;
      const float xi_117 = xi_114 - xi_116;
      const float xi_133 = -xi_114 + xi_116;
      const float xib_25_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2];
      ...
      const float xi_88 = xi_87*xib_22_collide;
      const float xi_101 = xi_87*xib_24_collide;
      ...
      const float xi_82 = u_0_b_collide*xib_24_collide;
      ...
      const float xi_363 = omega_shear_b*(rho_b_collide*xi_348 - xi_357 - xi_360 - xi_362 - xib_20_collide - xib_3_collide);
      const float xi_381 = u_0_b_collide*xi_367;
      const float xi_382 = xi_375 + xi_381 - xib_15_collide + xib_6_collide;
      const float xi_383 = xi_372*xi_382;
      const float xi_386 = xi_381 + xi_385 + xib_12_collide - xib_17_collide;
      const float xi_387 = xi_372*xi_386;
      const float xi_397 = xi_382*xi_396;
      const float xi_398 = -xi_397;
      const float xi_414 = xi_386*xi_396;
      const float xi_415 = -xi_414;
      const float u_1_b_collide = xib_2_collide;
      const float xi_83 = u_1_b_collide*xib_22_collide;
      ...
      const float xi_126 = xi_125*xib_24_collide;
      const float xi_130 = u_1_b_collide*xi_127;
      const float xi_131 = xi_130*xib_24_collide;
      ...
      const float xi_153 = omega_even_b*u_1_b_collide*xib_22_collide*-0.041666666666666664f;
      const float xi_350 = u_1_b_collide*u_1_b_collide;
      const float xi_351 = rho_b_collide*xi_350*-0.33333333333333331f + xi_349;
      const float xi_365 = omega_shear_b*(rho_b_collide*xi_350 - xi_360 - xi_364 - xib_13_collide - xib_26_collide);
      const float xi_368 = u_1_b_collide*xi_367;
      const float xi_371 = xi_368 + xi_370 + xib_1_collide - xib_21_collide;
      const float xi_373 = xi_371*xi_372;
      const float xi_376 = xi_368 + xi_375 + xib_15_collide - xib_6_collide;
      const float xi_377 = xi_372*xi_376;
      const float xi_399 = rho_b_collide*u_1_b_collide;
      const float xi_401 = xi_400*(u_0_b_collide*xi_399 + xi_359 + xi_374 - xib_11_collide);
      const float xi_402 = -xi_401;
      const float xi_404 = xi_376*xi_396;
      const float xi_407 = xi_371*xi_396;
      const float xi_412 = -xi_407;
      const float u_2_b_collide = xib_16_collide;
      ...
      const float xi_157 = u_2_b_collide*xib_24_collide;
      ...
      const float xi_346 = u_2_b_collide*u_2_b_collide;
      ...
      const float xi_358 = omega_even_b*(rho_b_collide*xi_350*-0.16666666666666666f - xi_347 - xi_349 - xi_355 - xi_357);
      const float xi_361 = omega_even_b*(rho_b_collide*xi_346*-0.16666666666666666f - xi_351 - xi_355 - xi_360);
      const float xi_366 = omega_shear_b*(rho_b_collide*xi_346 - xi_357 - xi_364 - xib_23_collide - xib_7_collide);
      ...
      const float xi_391 = xi_370 + xi_390 - xib_1_collide + xib_21_collide;
      const float xi_392 = xi_372*xi_391;
      const float xi_393 = xi_385 + xi_390 - xib_12_collide + xib_17_collide;
      ...
      const float xi_416 = xi_400*(rho_b_collide*u_0_b_collide*u_2_b_collide + xi_356 + xi_384 - xib_4_collide);
      ...
      const float forceTerm_0_b_collide = omega_shear_b*u_0_b_collide*xib_24_collide + omega_shear_b*u_1_b_collide*xib_22_collide + omega_shear_b*u_2_b_collide*xib_14_collide - xi_82*xi_85 - xi_82 - xi_83*xi_85 - xi_83 - xi_84*xi_85 - xi_84;
      ...
      const float tmp_a0 = forceTerm_0_a_collide + xi_172 + xi_176 + xi_179 - xi_182 - xi_183 - xi_184 + xi_245 + xia_4_collide;
      const float tmp_a1 = forceTerm_1_a_collide - xi_252 - xi_256 + xi_259 + xi_262 + xia_15_collide;
      const float tmp_a2 = forceTerm_2_a_collide + xi_252 + xi_256 + xi_262 + xi_263 + xia_21_collide;
      const float tmp_a3 = forceTerm_3_a_collide + xi_266 + xi_270 + xi_271 + xi_273 + xia_9_collide;
      const float tmp_a4 = forceTerm_4_a_collide - xi_266 - xi_270 + xi_273 + xi_274 + xia_17_collide;
      const float tmp_a5 = forceTerm_5_a_collide - xi_277 - xi_279 + xi_280 + xi_281 + xia_18_collide;
      const float tmp_a6 = forceTerm_6_a_collide + xi_277 + xi_279 + xi_281 + xi_282 + xia_25_collide;
      const float tmp_a7 = forceTerm_7_a_collide + xi_285 + xi_289 + xi_298 + xi_301 + xia_12_collide;
      const float tmp_a8 = forceTerm_8_a_collide + xi_284 + xi_288 + xi_301 + xi_307 + xia_20_collide;
      const float tmp_a9 = forceTerm_9_a_collide + xi_285 + xi_288 + xi_308 + xi_309 + xia_23_collide;
      const float tmp_a10 = forceTerm_10_a_collide + xi_284 + xi_289 + xi_309 + xi_310 + xia_2_collide;
      const float tmp_a11 = forceTerm_11_a_collide + xi_311 + xi_312 + xi_317 + xi_320 + xia_19_collide;
      const float tmp_a12 = forceTerm_12_a_collide + xi_320 + xi_321 + xi_322 + xi_326 + xia_13_collide;
      const float tmp_a13 = forceTerm_13_a_collide + xi_328 + xi_330 + xi_333 + xi_336 + xia_7_collide;
      const float tmp_a14 = forceTerm_14_a_collide + xi_327 + xi_329 + xi_336 + xi_339 + xia_14_collide;
      const float tmp_a15 = forceTerm_15_a_collide + xi_311 + xi_322 + xi_340 + xi_341 + xia_22_collide;
      const float tmp_a16 = forceTerm_16_a_collide + xi_312 + xi_321 + xi_341 + xi_342 + xia_24_collide;
      const float tmp_a17 = forceTerm_17_a_collide + xi_328 + xi_329 + xi_343 + xi_344 + xia_8_collide;
      const float tmp_a18 = forceTerm_18_a_collide + xi_327 + xi_330 + xi_344 + xi_345 + xia_1_collide;
      const float tmp_b0 = forceTerm_0_b_collide + xi_245 + xi_354 + xi_358 + xi_361 - xi_363 - xi_365 - xi_366 + xib_25_collide;
      const float tmp_b1 = forceTerm_1_b_collide + xi_259 - xi_373 - xi_377 + xi_380 + xib_26_collide;
      const float tmp_b2 = forceTerm_2_b_collide + xi_263 + xi_373 + xi_377 + xi_380 + xib_13_collide;
      const float tmp_b3 = forceTerm_3_b_collide + xi_271 + xi_383 + xi_387 + xi_389 + xib_3_collide;
      const float tmp_b4 = forceTerm_4_b_collide + xi_274 - xi_383 - xi_387 + xi_389 + xib_20_collide;
      const float tmp_b5 = forceTerm_5_b_collide + xi_280 - xi_392 - xi_394 + xi_395 + xib_7_collide;
      const float tmp_b6 = forceTerm_6_b_collide + xi_282 + xi_392 + xi_394 + xi_395 + xib_23_collide;
      const float tmp_b7 = forceTerm_7_b_collide + xi_298 + xi_398 + xi_402 + xi_405 + xib_6_collide;
      const float tmp_b8 = forceTerm_8_b_collide + xi_307 + xi_397 + xi_401 + xi_405 + xib_19_collide;
      const float tmp_b9 = forceTerm_9_b_collide + xi_308 + xi_398 + xi_401 + xi_406 + xib_11_collide;
      const float tmp_b10 = forceTerm_10_b_collide + xi_310 + xi_397 + xi_402 + xi_406 + xib_15_collide;
      const float tmp_b11 = forceTerm_11_b_collide + xi_317 + xi_407 + xi_408 + xi_411 + xib_5_collide;
      const float tmp_b12 = forceTerm_12_b_collide + xi_326 + xi_411 + xi_412 + xi_413 + xib_1_collide;
      const float tmp_b13 = forceTerm_13_b_collide + xi_333 + xi_415 + xi_417 + xi_420 + xib_12_collide;
      const float tmp_b14 = forceTerm_14_b_collide + xi_339 + xi_414 + xi_416 + xi_420 + xib_9_collide;
      const float tmp_b15 = forceTerm_15_b_collide + xi_340 + xi_407 + xi_413 + xi_421 + xib_21_collide;
      const float tmp_b16 = forceTerm_16_b_collide + xi_342 + xi_408 + xi_412 + xi_421 + xib_10_collide;
      const float tmp_b17 = forceTerm_17_b_collide + xi_343 + xi_415 + xi_416 + xi_422 + xib_4_collide;
      const float tmp_b18 = forceTerm_18_b_collide + xi_345 + xi_414 + xi_417 + xi_422 + xib_17_collide;
