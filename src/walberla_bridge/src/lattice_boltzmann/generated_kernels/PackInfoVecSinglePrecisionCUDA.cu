...
void PackInfoVecSinglePrecisionCUDA::pack(Direction dir,
...
void PackInfoVecSinglePrecisionCUDA::unpack(Direction dir,
                                            unsigned char *byte_buffer,
                                            IBlock *block, gpuStream_t stream) {
  float *buffer = reinterpret_cast<float *>(byte_buffer);
...
uint_t PackInfoVecSinglePrecisionCUDA::size(stencil::Direction dir,
                                            IBlock *block) {
  auto field = block->getData<gpu::GPUField<float>>(fieldID);
