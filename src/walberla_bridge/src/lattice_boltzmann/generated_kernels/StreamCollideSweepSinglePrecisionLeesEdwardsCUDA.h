...
//
//! \\file StreamCollideSweepSinglePrecisionLeesEdwardsCUDA.h
//! \\author pystencils
//======================================================================================================================
...
class StreamCollideSweepSinglePrecisionLeesEdwardsCUDA {
public:
  StreamCollideSweepSinglePrecisionLeesEdwardsCUDA(
  ...
  getSweep(const shared_ptr<StreamCollideSweepSinglePrecisionLeesEdwardsCUDA>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *, gpuStream_t)> getSweepOnCellInterval(
      const shared_ptr<StreamCollideSweepSinglePrecisionLeesEdwardsCUDA>
          &kernel,
