...
__launch_bounds__(256) void initialpdfssetterdoubleprecisioncuda_initialpdfssetterdoubleprecisioncuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 &&
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        delta_rho * 0.055555555555555552 + rho * u_1 * 0.16666666666666666 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        delta_rho * 0.055555555555555552 + rho * u_0 * -0.16666666666666666 +
        rho * -0.16666666666666666 * (u_1 * u_1) +
        rho * -0.16666666666666666 * (u_2 * u_2) +
        rho * 0.16666666666666666 * (u_0 * u_0);
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        delta_rho * 0.055555555555555552 + rho * u_2 * 0.16666666666666666 +
        rho * -0.16666666666666666 * (u_0 * u_0) +
        rho * -0.16666666666666666 * (u_1 * u_1) +
        rho * 0.16666666666666666 * (u_2 * u_2);
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        delta_rho * 0.027777777777777776 + rho * u_0 * u_1 * -0.25 +
        rho * u_0 * -0.083333333333333329 + rho * u_1 * 0.083333333333333329 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        delta_rho * 0.027777777777777776 + rho * u_1 * u_2 * 0.25 +
        rho * u_1 * 0.083333333333333329 + rho * u_2 * 0.083333333333333329 +
        rho * 0.083333333333333329 * (u_1 * u_1) +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        delta_rho * 0.027777777777777776 + rho * u_0 * u_2 * -0.25 +
        rho * u_0 * -0.083333333333333329 + rho * u_2 * 0.083333333333333329 +
        rho * 0.083333333333333329 * (u_0 * u_0) +
        rho * 0.083333333333333329 * (u_2 * u_2);
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
