...
updatevelfrompdfdoubleprecisionavx_updatevelfrompdfdoubleprecisionavx(
      ...
      for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
        {
          for (int64_t ctr_0 = 1;
            ...
            const __m256d momdensity_0 = _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(
                        _mm256_add_pd(
                            _mm256_add_pd(
            ...
            const __m256d momdensity_1 = _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(
                        _mm256_add_pd(
                            _mm256_add_pd(
            ...
            _mm256_store_pd(&_data_velocity[_stride_velocity_1 * ctr_1 +
                                            _stride_velocity_2 * ctr_2 + ctr_0],
                            u_0);
            _mm256_storeu_pd(&_data_velocity[_stride_velocity_1 * ctr_1 +
...
void UpdateVelFromPDFDoublePrecisionAVX::run(IBlock *block) {
  ...
  internal_fb7a198ee8d4b87d3091e088a14673a2::
      updatevelfrompdfdoubleprecisionavx_updatevelfrompdfdoubleprecisionavx(
...
void UpdateVelFromPDFDoublePrecisionAVX::runOnCellInterval(
