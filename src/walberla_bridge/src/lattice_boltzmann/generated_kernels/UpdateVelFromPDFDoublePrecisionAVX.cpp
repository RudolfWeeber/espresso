      ...
      for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
        {
          for (int64_t ctr_0 = 1; ctr_0 < (int64_t)((_size_force_0 - 2) / (4)) * (4) + 1; ctr_0 += 4) {
            ...
            const __m256d rho = _mm256_mul_pd(_mm256_add_pd(_mm256_set_pd(1.0, 1.0, 1.0, 1.0), delta_rho), _mm256_set_pd(density, density, density, density));
...
void UpdateVelFromPDFDoublePrecisionAVX::run(IBlock *block) {
  ...
  internal_fb7a198ee8d4b87d3091e088a14673a2::updatevelfrompdfdoubleprecisionavx_updatevelfrompdfdoubleprecisionavx(_data_force, _data_pdfs, _data_velocity, _size_force_0, _size_force_1, _size_force_2, _stride_force_1, _stride_force_2, _stride_force_3, _stride_pdfs_1, _stride_pdfs_2, _stride_pdfs_3, _stride_velocity_1, _stride_velocity_2, _stride_velocity_3, density);
}
