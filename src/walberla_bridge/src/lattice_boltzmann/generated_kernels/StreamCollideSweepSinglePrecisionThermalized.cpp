...
//
//! \\file StreamCollideSweepSinglePrecisionThermalized.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "StreamCollideSweepSinglePrecisionThermalized.h"
...
namespace internal_c9502d2ba75af3ad6bde4be90db2a757 {
static FUNC_PREFIX void
streamcollidesweepsingleprecisionthermalized_streamcollidesweepsingleprecisionthermalized(
        ...
        for (int64_t ctr_0 = 1; ctr_0 < _size_force_0 - 1; ctr_0 += 1) {
          ...
          if (kT > 0.) {
            philox_float4(time_step, block_offset_0 + ctr_0,
                          ...
                          seed, random_3_0, random_3_1, random_3_2, random_3_3);
          }
          ...
          if (kT > 0.) {
            philox_float4(time_step, block_offset_0 + ctr_0,
                          ...
                          seed, random_2_0, random_2_1, random_2_2, random_2_3);
          }
          ...
          if (kT > 0.) {
            philox_float4(time_step, block_offset_0 + ctr_0,
                          ...
                          seed, random_1_0, random_1_1, random_1_2, random_1_3);
          }
          ...
          if (kT > 0.) {
            philox_float4(time_step, block_offset_0 + ctr_0,
                          ...
                          seed, random_0_0, random_0_1, random_0_2, random_0_3);
          }
          const float xi_2 =
...
void StreamCollideSweepSinglePrecisionThermalized::run(IBlock *block) {
  if (!this->configured_)
  ...
  internal_c9502d2ba75af3ad6bde4be90db2a757::
      streamcollidesweepsingleprecisionthermalized_streamcollidesweepsingleprecisionthermalized(
...
void StreamCollideSweepSinglePrecisionThermalized::runOnCellInterval(
