...
//
//! \\file UpdateVelFromPDFSinglePrecisionCUDA.h
//! \\author pystencils
//======================================================================================================================
...
class UpdateVelFromPDFSinglePrecisionCUDA {
public:
  UpdateVelFromPDFSinglePrecisionCUDA(BlockDataID forceID_, BlockDataID pdfsID_,
                                      BlockDataID velocityID_, float density)
  ...
  getSweep(const shared_ptr<UpdateVelFromPDFSinglePrecisionCUDA> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *, gpuStream_t)> getSweepOnCellInterval(
      const shared_ptr<UpdateVelFromPDFSinglePrecisionCUDA> &kernel,
  ...
  inline void setDensity(const float value) { density_ = value; }
