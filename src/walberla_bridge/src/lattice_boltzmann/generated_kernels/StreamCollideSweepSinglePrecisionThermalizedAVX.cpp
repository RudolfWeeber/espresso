...
//
//! \\file StreamCollideSweepSinglePrecisionThermalizedAVX.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "StreamCollideSweepSinglePrecisionThermalizedAVX.h"
...
namespace internal_0ae93c82e35401d8a507fa8135e45553 {
static FUNC_PREFIX void
streamcollidesweepsingleprecisionthermalizedavx_streamcollidesweepsingleprecisionthermalizedavx(
      ...
      for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
        {
          for (int64_t ctr_0 = 1;
            ...
            _mm256_storeu_ps(
                ...
                _mm256_add_ps(
                    _mm256_add_ps(
                        _mm256_add_ps(_mm256_add_ps(forceTerm_11, xi_232),
                                      xi_237),
                        xi_243),
                    _mm256_loadu_ps(
                        &_data_pdfs[_stride_pdfs_1 * ctr_1 - _stride_pdfs_1 +
                        ...
                        _mm256_add_ps(
                            ...
                            _mm256_mul_ps(xi_244,
                                          _mm256_set_ps(-1.0f, -1.0f, -1.0f,
                                                        -1.0f, -1.0f, -1.0f,
                                                        -1.0f, -1.0f))),
                        _mm256_mul_ps(xi_245, _mm256_set_ps(-1.0f, -1.0f, -1.0f,
                                                            -1.0f, -1.0f, -1.0f,
                                                            -1.0f, -1.0f))),
                    forceTerm_12));
            _mm256_storeu_ps(
                ...
                _mm256_add_ps(
                    _mm256_add_ps(
                        _mm256_add_ps(_mm256_add_ps(forceTerm_13, xi_250),
                                      xi_253),
                        xi_258),
                    _mm256_loadu_ps(
                        &_data_pdfs[_stride_pdfs_1 * ctr_1 +
            ...
            _mm256_storeu_ps(
                ...
                _mm256_add_ps(
                    _mm256_add_ps(
                        _mm256_add_ps(_mm256_add_ps(forceTerm_14, xi_250),
                                      xi_259),
                        xi_260),
                    _mm256_loadu_ps(
                        &_data_pdfs[_stride_pdfs_1 * ctr_1 +
          ...
          for (int64_t ctr_0 = (int64_t)((_size_force_0 - 2) / (8)) * (8) + 1;
            ...
            if (kT > 0.) {
              philox_float4(time_step, block_offset_0 + ctr_0,
                            ...
                            seed, random_3_0, random_3_1, random_3_2,
                            random_3_3);
            }
            ...
            if (kT > 0.) {
              philox_float4(time_step, block_offset_0 + ctr_0,
                            ...
                            seed, random_2_0, random_2_1, random_2_2,
                            random_2_3);
            }
            ...
            if (kT > 0.) {
              philox_float4(time_step, block_offset_0 + ctr_0,
                            ...
                            seed, random_1_0, random_1_1, random_1_2,
                            random_1_3);
            }
            ...
            if (kT > 0.) {
              philox_float4(time_step, block_offset_0 + ctr_0,
                            ...
                            seed, random_0_0, random_0_1, random_0_2,
                            random_0_3);
            }
            const float xi_2 =
                _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
...
void StreamCollideSweepSinglePrecisionThermalizedAVX::run(IBlock *block) {
  if (!this->configured_)
  ...
  internal_0ae93c82e35401d8a507fa8135e45553::
      streamcollidesweepsingleprecisionthermalizedavx_streamcollidesweepsingleprecisionthermalizedavx(
...
void StreamCollideSweepSinglePrecisionThermalizedAVX::runOnCellInterval(
