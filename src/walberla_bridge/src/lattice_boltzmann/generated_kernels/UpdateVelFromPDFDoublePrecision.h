...
//
//! \\file UpdateVelFromPDFDoublePrecision.h
//! \\author pystencils
//======================================================================================================================
...
class UpdateVelFromPDFDoublePrecision {
public:
  UpdateVelFromPDFDoublePrecision(BlockDataID forceID_, BlockDataID pdfsID_,
  ...
  getSweep(const shared_ptr<UpdateVelFromPDFDoublePrecision> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<UpdateVelFromPDFDoublePrecision> &kernel,
