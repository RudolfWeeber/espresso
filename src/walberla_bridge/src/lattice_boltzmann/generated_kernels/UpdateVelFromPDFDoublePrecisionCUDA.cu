...
//
//! \\file UpdateVelFromPDFDoublePrecisionCUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_updatevelfrompdfdoubleprecisioncuda_updatevelfrompdfdoubleprecisioncuda {
static FUNC_PREFIX
__launch_bounds__(256) void updatevelfrompdfdoubleprecisioncuda_updatevelfrompdfdoubleprecisioncuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x + 1 < _size_force_0 - 1 &&
    ...
    _data_velocity[_stride_velocity_0 * ctr_0 + _stride_velocity_1 * ctr_1 +
                   _stride_velocity_2 * ctr_2] = u_0;
    _data_velocity[_stride_velocity_0 * ctr_0 + _stride_velocity_1 * ctr_1 +
                   _stride_velocity_2 * ctr_2 + _stride_velocity_3] = u_1;
    _data_velocity[_stride_velocity_0 * ctr_0 + _stride_velocity_1 * ctr_1 +
                   _stride_velocity_2 * ctr_2 + 2 * _stride_velocity_3] = u_2;
  }
}
} // namespace
  // internal_updatevelfrompdfdoubleprecisioncuda_updatevelfrompdfdoubleprecisioncuda

void UpdateVelFromPDFDoublePrecisionCUDA::run(IBlock *block,
                                              gpuStream_t stream) {
           ...
           2) % (((64 <
              ...
              : ((int64_t)(_size_force_2 - 2) /
                 (int64_t)((
                    ...
                    1)));
  internal_updatevelfrompdfdoubleprecisioncuda_updatevelfrompdfdoubleprecisioncuda::
      updatevelfrompdfdoubleprecisioncuda_updatevelfrompdfdoubleprecisioncuda<<<
...
void UpdateVelFromPDFDoublePrecisionCUDA::runOnCellInterval(
