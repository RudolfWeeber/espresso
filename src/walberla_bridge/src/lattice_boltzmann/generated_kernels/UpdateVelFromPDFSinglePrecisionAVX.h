...
//
//! \\file UpdateVelFromPDFSinglePrecisionAVX.h
//! \\author pystencils
//======================================================================================================================
...
class UpdateVelFromPDFSinglePrecisionAVX {
public:
  UpdateVelFromPDFSinglePrecisionAVX(BlockDataID forceID_, BlockDataID pdfsID_,
  ...
  getSweep(const shared_ptr<UpdateVelFromPDFSinglePrecisionAVX> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<UpdateVelFromPDFSinglePrecisionAVX> &kernel,
