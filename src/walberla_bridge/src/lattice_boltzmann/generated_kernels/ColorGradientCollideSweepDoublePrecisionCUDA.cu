...
static FUNC_PREFIX __launch_bounds__(256) void colorgradientcollidesweepdoubleprecisioncuda_colorgradientcollidesweepdoubleprecisioncuda(double * RESTRICT const _data_force_a, double * RESTRICT const _data_force_b, double * RESTRICT  _data_pdfs_a, double * RESTRICT  _data_pdfs_b, double * RESTRICT const _data_phasefield, double * RESTRICT const _data_rho_a, double * RESTRICT const _data_rho_b, double * RESTRICT const _data_velocity, int64_t const _size_force_a_0, int64_t const _size_force_a_1, int64_t const _size_force_a_2, int64_t const _stride_force_a_0, int64_t const _stride_force_a_1, int64_t const _stride_force_a_2, int64_t const _stride_force_a_3, int64_t const _stride_force_b_0, int64_t const _stride_force_b_1, int64_t const _stride_force_b_2, int64_t const _stride_force_b_3, int64_t const _stride_pdfs_a_0, int64_t const _stride_pdfs_a_1, int64_t const _stride_pdfs_a_2, int64_t const _stride_pdfs_a_3, int64_t const _stride_pdfs_b_0, int64_t const _stride_pdfs_b_1, int64_t const _stride_pdfs_b_2, int64_t const _stride_pdfs_b_3, int64_t const _stride_phasefield_0, int64_t const _stride_phasefield_1, int64_t const _stride_phasefield_2, int64_t const _stride_rho_a_0, int64_t const _stride_rho_a_1, int64_t const _stride_rho_a_2, int64_t const _stride_rho_b_0, int64_t const _stride_rho_b_1, int64_t const _stride_rho_b_2, int64_t const _stride_velocity_0, int64_t const _stride_velocity_1, int64_t const _stride_velocity_2, int64_t const _stride_velocity_3, double omega_even_a, double omega_even_b, double omega_odd_a, double omega_odd_b, double omega_shear_a, double omega_shear_b)
{
   if (blockDim.x*blockIdx.x + threadIdx.x + 1 < _size_force_a_0 - 1 && blockDim.y*blockIdx.y + threadIdx.y + 1 < _size_force_a_1 - 1 && blockDim.z*blockIdx.z + threadIdx.z + 1 < _size_force_a_2 - 1)
   {
      ...
      const double xia_1_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 14*_stride_pdfs_a_3];
      const double xi_260 = -xia_1_collide;
      const double xia_2_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      const double xia_3_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 3*_stride_pdfs_a_3];
      const double xia_4_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2];
      ...
      const double xia_6_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3];
      const double xia_7_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 5*_stride_pdfs_a_3];
      const double xia_8_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3];
      const double xi_26 = xia_8_collide*0.16666666666666666;
      const double xi_28 = omega_odd_a*xi_26;
      const double xi_55 = xia_8_collide*0.083333333333333329;
      const double xi_56 = xi_33*xia_8_collide;
      ...
      const double xia_10_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 11*_stride_pdfs_a_3];
      const double xi_241 = -xia_10_collide;
      const double xia_11_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 16*_stride_pdfs_a_3];
      const double xi_242 = xi_241 + xia_11_collide;
      const double xia_12_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 2*_stride_pdfs_a_3];
      ...
      const double xia_14_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 9*_stride_pdfs_a_3];
      const double xia_15_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 6*_stride_pdfs_a_3];
      ...
      const double xia_17_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 17*_stride_pdfs_a_3];
      const double xi_261 = xi_260 + xia_17_collide;
      const double xia_18_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 8*_stride_pdfs_a_3];
      const double xi_246 = -xia_18_collide;
      const double xi_247 = xi_246 + xia_14_collide;
      const double xia_19_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 7*_stride_pdfs_a_3];
      const double xi_177 = xia_16_collide + xia_19_collide;
      const double xi_178 = xi_177 + xia_14_collide + xia_18_collide;
      const double xia_20_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2];
      const double xi_17 = xia_20_collide*0.16666666666666666;
      const double xi_18 = omega_odd_a*xi_17;
      const double xi_32 = xia_20_collide*0.083333333333333329;
      const double xi_34 = xi_33*xia_20_collide;
      const double xi_35 = xi_32 - xi_34;
      const double xi_51 = -xi_32 + xi_34;
      const double xia_21_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 18*_stride_pdfs_a_3];
      const double xia_22_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 4*_stride_pdfs_a_3];
      const double xia_23_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 15*_stride_pdfs_a_3];
      const double xi_170 = xia_23_collide + xia_5_collide;
      const double xi_171 = xi_170 + xia_10_collide + xia_11_collide;
      const double xia_24_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 13*_stride_pdfs_a_3];
      const double xi_174 = xia_21_collide + xia_24_collide;
      const double xi_175 = xi_174 + xia_17_collide + xia_1_collide;
      const double xia_25_collide = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_3];
      const double xia_26_collide = _data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + _stride_force_a_3];
      const double xi_4 = xia_26_collide*0.16666666666666666;
      const double xi_7 = omega_odd_a*xi_4;
      const double xi_37 = xia_26_collide*0.083333333333333329;
      const double xi_38 = xi_33*xia_26_collide;
      const double xi_39 = -xi_37 + xi_38;
      const double xi_41 = xia_26_collide*0.25;
      const double xi_46 = xi_45*xia_26_collide;
      const double xi_53 = xi_37 - xi_38;
      const double rr_0_a_collide = 0.0;
      const double xi_5 = rr_0_a_collide*0.25;
      const double xi_6 = xi_5*xia_26_collide;
      const double xi_19 = xi_5*xia_20_collide;
      const double xi_27 = xi_5*xia_8_collide;
      ...
      const double xi_182 = xi_171 + xi_180;
      const double xi_239 = rho_a_collide*0.33333333333333331;
      const double u_0_a_collide = xia_2_collide;
      const double xi_0 = u_0_a_collide*xia_20_collide;
      ...
      const double xi_73 = u_0_a_collide*xia_8_collide;
      ...
      const double xi_181 = omega_shear_a*(rho_a_collide*xi_166 - xi_175 - xi_178 - xi_180 - xia_22_collide - xia_3_collide);
      const double xi_257 = u_0_a_collide*xi_239;
      const double xi_258 = xi_247 + xi_257 - xia_16_collide + xia_19_collide;
      const double xi_259 = xi_244*xi_258;
      const double xi_262 = xi_257 + xi_261 - xia_21_collide + xia_24_collide;
      ...
      const double xi_1 = u_1_a_collide*xia_26_collide;
      ...
      const double xi_44 = xi_43*xia_20_collide;
      const double xi_48 = u_1_a_collide*xi_45;
      const double xi_49 = xi_48*xia_20_collide;
      const double xi_50 = xi_42 + xi_44 - xi_47 - xi_49;
      const double xi_52 = -xi_42 - xi_44 + xi_47 + xi_49;
      const double xi_59 = -xi_23;
      const double xi_63 = xi_43*xia_8_collide;
      const double xi_65 = xi_48*xia_8_collide;
      const double xi_71 = omega_even_a*u_1_a_collide*xia_26_collide*-0.041666666666666664;
      const double xi_168 = u_1_a_collide*u_1_a_collide;
      const double xi_169 = rho_a_collide*xi_168*-0.33333333333333331 + xi_167;
      const double xi_183 = omega_shear_a*(rho_a_collide*xi_168 - xi_178 - xi_182 - xia_12_collide - xia_25_collide);
      const double xi_240 = u_1_a_collide*xi_239;
      const double xi_243 = xi_240 + xi_242 - xia_23_collide + xia_5_collide;
      const double xi_245 = xi_243*xi_244;
      const double xi_248 = xi_240 + xi_247 + xia_16_collide - xia_19_collide;
      const double xi_249 = xi_244*xi_248;
      const double xi_279 = rho_a_collide*u_1_a_collide;
      const double xi_281 = xi_280*(u_0_a_collide*xi_279 + xi_177 + xi_246 - xia_14_collide);
      const double xi_282 = -xi_281;
      const double xi_293 = xi_248*xi_276;
      const double xi_304 = xi_243*xi_276;
      const double xi_314 = -xi_304;
      const double u_2_a_collide = xia_6_collide;
      const double xi_2 = u_2_a_collide*xia_8_collide;
      ...
      const double xi_36 = omega_even_a*u_2_a_collide*xia_8_collide*-0.041666666666666664;
      ...
      const double xi_75 = u_2_a_collide*xia_20_collide;
      ...
      const double xi_184 = omega_shear_a*(rho_a_collide*xi_164 - xi_175 - xi_182 - xia_15_collide - xia_7_collide);
      const double xi_253 = xi_172*-0.5;
      const double xi_254 = xi_179*-0.5;
      const double xi_255 = xi_183*0.5 + xi_253 + xi_254;
      const double xi_265 = xi_176*-0.5;
      const double xi_266 = xi_181*0.5 + xi_254 + xi_265;
      const double xi_268 = u_2_a_collide*xi_239;
      const double xi_269 = xi_242 + xi_268 + xia_23_collide - xia_5_collide;
      const double xi_270 = xi_244*xi_269;
      const double xi_271 = xi_261 + xi_268 + xia_21_collide - xia_24_collide;
      const double xi_272 = xi_244*xi_271;
      const double xi_274 = xi_184*0.5 + xi_253 + xi_265;
      const double xi_292 = xi_179*0.25;
      const double xi_294 = xi_292 + xi_293;
      const double xi_302 = xi_292 - xi_293;
      const double xi_305 = xi_280*(u_2_a_collide*xi_279 + xi_170 + xi_241 - xia_11_collide);
      const double xi_311 = xi_172*0.25;
      const double xi_312 = xi_269*xi_276;
      const double xi_313 = xi_311 + xi_312;
      const double xi_315 = -xi_305;
      const double xi_322 = xi_280*(rho_a_collide*u_0_a_collide*u_2_a_collide + xi_174 + xi_260 - xia_17_collide);
      const double xi_323 = -xi_322;
      const double xi_327 = xi_176*0.25;
      const double xi_328 = xi_271*xi_276;
      const double xi_329 = xi_327 + xi_328;
      const double xi_334 = xi_311 - xi_312;
      const double xi_337 = xi_327 - xi_328;
      const double forceTerm_0_a_collide = omega_shear_a*u_0_a_collide*xia_20_collide + omega_shear_a*u_1_a_collide*xia_26_collide + omega_shear_a*u_2_a_collide*xia_8_collide - xi_0*xi_3 - xi_0 - xi_1*xi_3 - xi_1 - xi_2*xi_3 - xi_2;
      ...
      const double xib_1_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2];
      const double xib_2_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 4*_stride_pdfs_b_3];
      const double xib_3_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 5*_stride_pdfs_b_3];
      const double xib_4_collide = _data_rho_b[_stride_rho_b_0*ctr_0 + _stride_rho_b_1*ctr_1 + _stride_rho_b_2*ctr_2];
      const double xib_5_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + 2*_stride_velocity_3];
      const double xib_6_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2];
      const double xib_7_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 11*_stride_pdfs_b_3];
      const double xi_362 = -xib_7_collide;
      const double xib_8_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_3];
      const double xib_9_collide = _data_velocity[_stride_velocity_0*ctr_0 + _stride_velocity_1*ctr_1 + _stride_velocity_2*ctr_2 + _stride_velocity_3];
      const double xib_10_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + _stride_force_b_3];
      const double xi_86 = xib_10_collide*0.16666666666666666;
      const double xi_89 = omega_odd_b*xi_86;
      const double xi_119 = xib_10_collide*0.083333333333333329;
      const double xi_120 = xi_115*xib_10_collide;
      const double xi_121 = -xi_119 + xi_120;
      const double xi_123 = xib_10_collide*0.25;
      const double xi_128 = xi_127*xib_10_collide;
      const double xi_135 = xi_119 - xi_120;
      const double xib_11_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 7*_stride_pdfs_b_3];
      const double xib_12_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 16*_stride_pdfs_b_3];
      const double xi_363 = xi_362 + xib_12_collide;
      const double xib_13_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 2*_stride_pdfs_b_3];
      const double xib_14_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 14*_stride_pdfs_b_3];
      const double xi_377 = -xib_14_collide;
      const double xib_15_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 6*_stride_pdfs_b_3];
      const double xib_16_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + 2*_stride_force_b_3];
      const double xi_108 = xib_16_collide*0.16666666666666666;
      const double xi_110 = omega_odd_b*xi_108;
      const double xi_137 = xib_16_collide*0.083333333333333329;
      const double xi_138 = xi_115*xib_16_collide;
      const double xi_139 = xi_137 - xi_138;
      const double xi_152 = -xi_137 + xi_138;
      const double xib_17_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 18*_stride_pdfs_b_3];
      const double xib_18_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 17*_stride_pdfs_b_3];
      const double xi_378 = xi_377 + xib_18_collide;
      const double xib_19_collide = _data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2];
      const double xi_99 = xib_19_collide*0.16666666666666666;
      const double xi_100 = omega_odd_b*xi_99;
      const double xi_114 = xib_19_collide*0.083333333333333329;
      const double xi_116 = xi_115*xib_19_collide;
      const double xi_117 = xi_114 - xi_116;
      const double xi_133 = -xi_114 + xi_116;
      const double xib_20_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 10*_stride_pdfs_b_3];
      const double xi_352 = xib_11_collide + xib_20_collide;
      const double xib_21_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 9*_stride_pdfs_b_3];
      ...
      const double xib_23_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3];
      const double xi_353 = xi_352 + xib_21_collide + xib_23_collide;
      const double xi_367 = -xib_23_collide;
      const double xi_368 = xi_367 + xib_21_collide;
      const double xib_24_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 13*_stride_pdfs_b_3];
      const double xi_349 = xib_17_collide + xib_24_collide;
      const double xi_350 = xi_349 + xib_14_collide + xib_18_collide;
      const double xib_25_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 15*_stride_pdfs_b_3];
      const double xi_345 = xib_22_collide + xib_25_collide;
      const double xi_346 = xi_345 + xib_12_collide + xib_7_collide;
      const double xib_26_collide = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3];
      const double rr_0_b_collide = 0.0;
      const double xi_87 = rr_0_b_collide*0.25;
      const double xi_88 = xi_87*xib_10_collide;
      const double xi_101 = xi_87*xib_19_collide;
      const double xi_109 = xi_87*xib_16_collide;
      const double rho_b_collide = xib_4_collide;
      const double xi_342 = rho_b_collide*-0.092592592592592601;
      const double xi_355 = rho_b_collide*-0.27777777777777773;
      const double xi_356 = xi_353 + xi_355;
      const double xi_360 = rho_b_collide*0.33333333333333331;
      const double u_0_b_collide = xib_1_collide;
      const double xi_82 = u_0_b_collide*xib_19_collide;
      ...
      const double xi_155 = u_0_b_collide*xib_16_collide;
      ...
      const double xi_357 = omega_shear_b*(rho_b_collide*xi_341 - xi_350 - xi_356 - xib_26_collide - xib_2_collide);
      const double xi_374 = u_0_b_collide*xi_360;
      const double xi_375 = xi_368 + xi_374 + xib_11_collide - xib_20_collide;
      const double xi_376 = xi_365*xi_375;
      const double xi_379 = xi_374 + xi_378 - xib_17_collide + xib_24_collide;
      const double xi_380 = xi_365*xi_379;
      const double xi_390 = xi_375*xi_389;
      const double xi_391 = -xi_390;
      const double xi_407 = xi_379*xi_389;
      const double xi_408 = -xi_407;
      const double u_1_b_collide = xib_9_collide;
      const double xi_83 = u_1_b_collide*xib_10_collide;
      ...
      const double xi_126 = xi_125*xib_19_collide;
      const double xi_130 = u_1_b_collide*xi_127;
      const double xi_131 = xi_130*xib_19_collide;
      const double xi_132 = xi_124 + xi_126 - xi_129 - xi_131;
      const double xi_134 = -xi_124 - xi_126 + xi_129 + xi_131;
      const double xi_141 = -xi_105;
      const double xi_145 = xi_125*xib_16_collide;
      const double xi_147 = xi_130*xib_16_collide;
      const double xi_153 = omega_even_b*u_1_b_collide*xib_10_collide*-0.041666666666666664;
      const double xi_343 = u_1_b_collide*u_1_b_collide;
      const double xi_344 = rho_b_collide*xi_343*-0.33333333333333331 + xi_342;
      const double xi_358 = omega_shear_b*(rho_b_collide*xi_343 - xi_346 - xi_356 - xib_13_collide - xib_8_collide);
      const double xi_361 = u_1_b_collide*xi_360;
      const double xi_364 = xi_361 + xi_363 + xib_22_collide - xib_25_collide;
      const double xi_366 = xi_364*xi_365;
      const double xi_369 = xi_361 + xi_368 - xib_11_collide + xib_20_collide;
      const double xi_370 = xi_365*xi_369;
      const double xi_392 = rho_b_collide*u_1_b_collide;
      const double xi_394 = xi_393*(u_0_b_collide*xi_392 + xi_352 + xi_367 - xib_21_collide);
      const double xi_395 = -xi_394;
      const double xi_397 = xi_369*xi_389;
      const double xi_400 = xi_364*xi_389;
      const double xi_405 = -xi_400;
      const double u_2_b_collide = xib_5_collide;
      const double xi_84 = u_2_b_collide*xib_16_collide;
      ...
      const double xi_118 = omega_even_b*u_2_b_collide*xib_16_collide*-0.041666666666666664;
      ...
      const double xi_157 = u_2_b_collide*xib_19_collide;
      ...
      const double xi_339 = u_2_b_collide*u_2_b_collide;
      ...
      const double xi_351 = omega_even_b*(rho_b_collide*xi_343*-0.16666666666666666 - xi_340 - xi_342 - xi_348 - xi_350);
      const double xi_354 = omega_even_b*(rho_b_collide*xi_339*-0.16666666666666666 - xi_344 - xi_348 - xi_353);
      const double xi_359 = omega_shear_b*(rho_b_collide*xi_339 - xi_346 - xi_350 - xi_355 - xib_15_collide - xib_3_collide);
      const double xi_371 = xi_354*-0.5;
      const double xi_372 = xi_347*-0.5;
      const double xi_373 = xi_358*0.5 + xi_371 + xi_372;
      const double xi_381 = xi_351*-0.5;
      const double xi_382 = xi_357*0.5 + xi_371 + xi_381;
      const double xi_383 = u_2_b_collide*xi_360;
      const double xi_384 = xi_363 + xi_383 - xib_22_collide + xib_25_collide;
      const double xi_385 = xi_365*xi_384;
      const double xi_386 = xi_378 + xi_383 + xib_17_collide - xib_24_collide;
      const double xi_387 = xi_365*xi_386;
      const double xi_388 = xi_359*0.5 + xi_372 + xi_381;
      const double xi_396 = xi_354*0.25;
      const double xi_398 = xi_396 + xi_397;
      const double xi_399 = xi_396 - xi_397;
      const double xi_401 = xi_393*(u_2_b_collide*xi_392 + xi_345 + xi_362 - xib_12_collide);
      ...
      const double xi_409 = xi_393*(rho_b_collide*u_0_b_collide*u_2_b_collide + xi_349 + xi_377 - xib_18_collide);
      ...
      const double forceTerm_0_b_collide = omega_shear_b*u_0_b_collide*xib_19_collide + omega_shear_b*u_1_b_collide*xib_10_collide + omega_shear_b*u_2_b_collide*xib_16_collide - xi_82*xi_85 - xi_82 - xi_83*xi_85 - xi_83 - xi_84*xi_85 - xi_84;
      ...
      const double tmp_a0 = forceTerm_0_a_collide + xi_172 + xi_176 + xi_179 - xi_181 - xi_183 - xi_184 + xi_238 + xia_4_collide;
      const double tmp_a1 = forceTerm_1_a_collide - xi_245 - xi_249 + xi_252 + xi_255 + xia_25_collide;
      const double tmp_a2 = forceTerm_2_a_collide + xi_245 + xi_249 + xi_255 + xi_256 + xia_12_collide;
      const double tmp_a3 = forceTerm_3_a_collide + xi_259 + xi_263 + xi_264 + xi_266 + xia_3_collide;
      const double tmp_a4 = forceTerm_4_a_collide - xi_259 - xi_263 + xi_266 + xi_267 + xia_22_collide;
      const double tmp_a5 = forceTerm_5_a_collide - xi_270 - xi_272 + xi_273 + xi_274 + xia_7_collide;
      const double tmp_a6 = forceTerm_6_a_collide + xi_270 + xi_272 + xi_274 + xi_275 + xia_15_collide;
      const double tmp_a7 = forceTerm_7_a_collide + xi_278 + xi_282 + xi_291 + xi_294 + xia_19_collide;
      const double tmp_a8 = forceTerm_8_a_collide + xi_277 + xi_281 + xi_294 + xi_300 + xia_18_collide;
      const double tmp_a9 = forceTerm_9_a_collide + xi_278 + xi_281 + xi_301 + xi_302 + xia_14_collide;
      const double tmp_a10 = forceTerm_10_a_collide + xi_277 + xi_282 + xi_302 + xi_303 + xia_16_collide;
      const double tmp_a11 = forceTerm_11_a_collide + xi_304 + xi_305 + xi_310 + xi_313 + xia_10_collide;
      const double tmp_a12 = forceTerm_12_a_collide + xi_313 + xi_314 + xi_315 + xi_319 + xia_5_collide;
      const double tmp_a13 = forceTerm_13_a_collide + xi_321 + xi_323 + xi_326 + xi_329 + xia_24_collide;
      const double tmp_a14 = forceTerm_14_a_collide + xi_320 + xi_322 + xi_329 + xi_332 + xia_1_collide;
      const double tmp_a15 = forceTerm_15_a_collide + xi_304 + xi_315 + xi_333 + xi_334 + xia_23_collide;
      const double tmp_a16 = forceTerm_16_a_collide + xi_305 + xi_314 + xi_334 + xi_335 + xia_11_collide;
      const double tmp_a17 = forceTerm_17_a_collide + xi_321 + xi_322 + xi_336 + xi_337 + xia_17_collide;
      const double tmp_a18 = forceTerm_18_a_collide + xi_320 + xi_323 + xi_337 + xi_338 + xia_21_collide;
      const double tmp_b0 = forceTerm_0_b_collide + xi_238 + xi_347 + xi_351 + xi_354 - xi_357 - xi_358 - xi_359 + xib_6_collide;
      const double tmp_b1 = forceTerm_1_b_collide + xi_252 - xi_366 - xi_370 + xi_373 + xib_8_collide;
      const double tmp_b2 = forceTerm_2_b_collide + xi_256 + xi_366 + xi_370 + xi_373 + xib_13_collide;
      const double tmp_b3 = forceTerm_3_b_collide + xi_264 + xi_376 + xi_380 + xi_382 + xib_26_collide;
      const double tmp_b4 = forceTerm_4_b_collide + xi_267 - xi_376 - xi_380 + xi_382 + xib_2_collide;
      const double tmp_b5 = forceTerm_5_b_collide + xi_273 - xi_385 - xi_387 + xi_388 + xib_3_collide;
      const double tmp_b6 = forceTerm_6_b_collide + xi_275 + xi_385 + xi_387 + xi_388 + xib_15_collide;
      const double tmp_b7 = forceTerm_7_b_collide + xi_291 + xi_391 + xi_395 + xi_398 + xib_11_collide;
      const double tmp_b8 = forceTerm_8_b_collide + xi_300 + xi_390 + xi_394 + xi_398 + xib_23_collide;
      const double tmp_b9 = forceTerm_9_b_collide + xi_301 + xi_391 + xi_394 + xi_399 + xib_21_collide;
      const double tmp_b10 = forceTerm_10_b_collide + xi_303 + xi_390 + xi_395 + xi_399 + xib_20_collide;
      const double tmp_b11 = forceTerm_11_b_collide + xi_310 + xi_400 + xi_401 + xi_404 + xib_7_collide;
      const double tmp_b12 = forceTerm_12_b_collide + xi_319 + xi_404 + xi_405 + xi_406 + xib_22_collide;
      const double tmp_b13 = forceTerm_13_b_collide + xi_326 + xi_408 + xi_410 + xi_413 + xib_24_collide;
      const double tmp_b14 = forceTerm_14_b_collide + xi_332 + xi_407 + xi_409 + xi_413 + xib_14_collide;
      const double tmp_b15 = forceTerm_15_b_collide + xi_333 + xi_400 + xi_406 + xi_414 + xib_25_collide;
      const double tmp_b16 = forceTerm_16_b_collide + xi_335 + xi_401 + xi_405 + xi_414 + xib_12_collide;
      const double tmp_b17 = forceTerm_17_b_collide + xi_336 + xi_408 + xi_409 + xi_415 + xib_18_collide;
      const double tmp_b18 = forceTerm_18_b_collide + xi_338 + xi_407 + xi_410 + xi_415 + xib_17_collide;
