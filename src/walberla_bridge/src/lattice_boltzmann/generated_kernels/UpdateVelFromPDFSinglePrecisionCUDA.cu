...
static FUNC_PREFIX
__launch_bounds__(256) void updatevelfrompdfsingleprecisioncuda_updatevelfrompdfsingleprecisioncuda(
  ...
  // internal_updatevelfrompdfsingleprecisioncuda_updatevelfrompdfsingleprecisioncuda

void UpdateVelFromPDFSinglePrecisionCUDA::run(IBlock *block,
                                              gpuStream_t stream) {
           ...
           2) % (((64 <
              ...
              : ((int64_t)(_size_force_2 - 2) /
                 (int64_t)((
                    ...
                    1)));
  internal_updatevelfrompdfsingleprecisioncuda_updatevelfrompdfsingleprecisioncuda::
      updatevelfrompdfsingleprecisioncuda_updatevelfrompdfsingleprecisioncuda<<<
...
void UpdateVelFromPDFSinglePrecisionCUDA::runOnCellInterval(
