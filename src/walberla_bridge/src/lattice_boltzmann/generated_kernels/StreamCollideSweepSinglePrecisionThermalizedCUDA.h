...
//
//! \\file StreamCollideSweepSinglePrecisionThermalizedCUDA.h
//! \\author pystencils
//======================================================================================================================
...
class StreamCollideSweepSinglePrecisionThermalizedCUDA {
public:
  StreamCollideSweepSinglePrecisionThermalizedCUDA(
  ...
  getSweep(const shared_ptr<StreamCollideSweepSinglePrecisionThermalizedCUDA>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *, gpuStream_t)> getSweepOnCellInterval(
      const shared_ptr<StreamCollideSweepSinglePrecisionThermalizedCUDA>
          &kernel,
