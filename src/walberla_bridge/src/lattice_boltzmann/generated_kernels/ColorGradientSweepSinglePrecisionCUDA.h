...
//
//! \\file ColorGradientSweepSinglePrecisionCUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ColorGradientSweepSinglePrecisionCUDA
{
public:
   ColorGradientSweepSinglePrecisionCUDA( BlockDataID color_gradientID_, BlockDataID phasefieldID_ )
   ...
   static std::function<void (IBlock *)> getSweep(const shared_ptr<ColorGradientSweepSinglePrecisionCUDA> & kernel)
   {
     return [kernel]
            (IBlock * b)
            { kernel->run(b); };
   ...
   static std::function<void (IBlock*, gpuStream_t )> getSweepOnCellInterval(const shared_ptr<ColorGradientSweepSinglePrecisionCUDA> & kernel, const shared_ptr<StructuredBlockStorage> & blocks, const CellInterval & globalCellInterval, cell_idx_t ghostLayers=1)
   {
