...
//
//! \\file ColorGradientInitialPDFsSetterDoublePrecisionCUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ColorGradientInitialPDFsSetterDoublePrecisionCUDA
{
public:
   ColorGradientInitialPDFsSetterDoublePrecisionCUDA( BlockDataID force_aID_, BlockDataID force_bID_, BlockDataID pdfs_aID_, BlockDataID pdfs_bID_, BlockDataID phasefieldID_, BlockDataID rho_aID_, BlockDataID rho_bID_, BlockDataID velocityID_ )
   ...
   static std::function<void (IBlock *)> getSweep(const shared_ptr<ColorGradientInitialPDFsSetterDoublePrecisionCUDA> & kernel)
   {
     return [kernel]
            (IBlock * b)
            { kernel->run(b); };
   ...
   static std::function<void (IBlock*, gpuStream_t )> getSweepOnCellInterval(const shared_ptr<ColorGradientInitialPDFsSetterDoublePrecisionCUDA> & kernel, const shared_ptr<StructuredBlockStorage> & blocks, const CellInterval & globalCellInterval, cell_idx_t ghostLayers=1)
   {
