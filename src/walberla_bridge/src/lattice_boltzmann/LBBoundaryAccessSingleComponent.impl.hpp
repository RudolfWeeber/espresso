 ...
 * @ref walberla::LBWalberlaImplSingleComponent. Most boundary methods have
 * moved into @ref walberla::LBWalberlaCommon; this file retains the leaf-
...
void LBWalberlaImplSingleComponent<FloatType, Architecture>::on_boundary_add() {
