...
//
//! \\file ColorGradientStreamSweepSinglePrecision.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "ColorGradientStreamSweepSinglePrecision.h"
...
void ColorGradientStreamSweepSinglePrecision::run(IBlock * block)
{
...
void ColorGradientStreamSweepSinglePrecision::runOnCellInterval(const shared_ptr<StructuredBlockStorage> & blocks, const CellInterval & globalCellInterval, cell_idx_t ghostLayers, IBlock * block)
{
