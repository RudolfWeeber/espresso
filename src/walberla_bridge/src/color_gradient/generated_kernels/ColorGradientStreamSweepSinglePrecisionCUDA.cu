...
//
//! \\file ColorGradientStreamSweepSinglePrecisionCUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "ColorGradientStreamSweepSinglePrecisionCUDA.h"
...
static FUNC_PREFIX __launch_bounds__(256) void colorgradientstreamsweepsingleprecisioncuda_colorgradientstreamsweepsingleprecisioncuda(float * RESTRICT const _data_force_a, float * RESTRICT const _data_force_b, float * RESTRICT const _data_pdfs_a, float * RESTRICT  _data_pdfs_a_tmp, float * RESTRICT const _data_pdfs_b, float * RESTRICT  _data_pdfs_b_tmp, float * RESTRICT  _data_phasefield, float * RESTRICT  _data_rho_a, float * RESTRICT  _data_rho_b, float * RESTRICT  _data_velocity, int64_t const _size_force_a_0, int64_t const _size_force_a_1, int64_t const _size_force_a_2, int64_t const _stride_force_a_0, int64_t const _stride_force_a_1, int64_t const _stride_force_a_2, int64_t const _stride_force_a_3, int64_t const _stride_force_b_0, int64_t const _stride_force_b_1, int64_t const _stride_force_b_2, int64_t const _stride_force_b_3, int64_t const _stride_pdfs_a_0, int64_t const _stride_pdfs_a_1, int64_t const _stride_pdfs_a_2, int64_t const _stride_pdfs_a_3, int64_t const _stride_pdfs_a_tmp_0, int64_t const _stride_pdfs_a_tmp_1, int64_t const _stride_pdfs_a_tmp_2, int64_t const _stride_pdfs_a_tmp_3, int64_t const _stride_pdfs_b_0, int64_t const _stride_pdfs_b_1, int64_t const _stride_pdfs_b_2, int64_t const _stride_pdfs_b_3, int64_t const _stride_pdfs_b_tmp_0, int64_t const _stride_pdfs_b_tmp_1, int64_t const _stride_pdfs_b_tmp_2, int64_t const _stride_pdfs_b_tmp_3, int64_t const _stride_phasefield_0, int64_t const _stride_phasefield_1, int64_t const _stride_phasefield_2, int64_t const _stride_rho_a_0, int64_t const _stride_rho_a_1, int64_t const _stride_rho_a_2, int64_t const _stride_rho_b_0, int64_t const _stride_rho_b_1, int64_t const _stride_rho_b_2, int64_t const _stride_velocity_0, int64_t const _stride_velocity_1, int64_t const _stride_velocity_2, int64_t const _stride_velocity_3)
{
   if (blockDim.x*blockIdx.x + threadIdx.x + 1 < _size_force_a_0 - 1 && blockDim.y*blockIdx.y + threadIdx.y + 1 < _size_force_a_1 - 1 && blockDim.z*blockIdx.z + threadIdx.z + 1 < _size_force_a_2 - 1)
   {
      ...
      const float streamed_0_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2];
      const float streamed_1_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 - _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_3];
      const float streamed_2_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + 2*_stride_pdfs_a_3];
      const float streamed_3_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 3*_stride_pdfs_a_3];
      const float streamed_4_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 - _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + 4*_stride_pdfs_a_3];
      const float streamed_5_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 - _stride_pdfs_a_2 + 5*_stride_pdfs_a_3];
      const float streamed_6_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_2 + 6*_stride_pdfs_a_3];
      const float streamed_7_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 - _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + 7*_stride_pdfs_a_3];
      const float streamed_8_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 - _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 - _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + 8*_stride_pdfs_a_3];
      const float streamed_9_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + 9*_stride_pdfs_a_3];
      const float streamed_10_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 - _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + 10*_stride_pdfs_a_3];
      const float streamed_11_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 - _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 - _stride_pdfs_a_2 + 11*_stride_pdfs_a_3];
      const float streamed_12_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 - _stride_pdfs_a_2 + 12*_stride_pdfs_a_3];
      const float streamed_13_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 - _stride_pdfs_a_2 + 13*_stride_pdfs_a_3];
      const float streamed_14_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 - _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 - _stride_pdfs_a_2 + 14*_stride_pdfs_a_3];
      const float streamed_15_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 - _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_2 + 15*_stride_pdfs_a_3];
      const float streamed_16_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_2 + 16*_stride_pdfs_a_3];
      const float streamed_17_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 + _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_2 + 17*_stride_pdfs_a_3];
      const float streamed_18_a = _data_pdfs_a[_stride_pdfs_a_0*ctr_0 - _stride_pdfs_a_0 + _stride_pdfs_a_1*ctr_1 + _stride_pdfs_a_2*ctr_2 + _stride_pdfs_a_2 + 18*_stride_pdfs_a_3];
      ...
      const float u_0_a = momdensity_0_a*((1.0f) / (rho_a)) + 0.5f*((1.0f) / (rho_a))*_data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2];
      const float u_1_a = momdensity_1_a*((1.0f) / (rho_a)) + 0.5f*((1.0f) / (rho_a))*_data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + _stride_force_a_3];
      const float u_2_a = momdensity_2_a*((1.0f) / (rho_a)) + 0.5f*((1.0f) / (rho_a))*_data_force_a[_stride_force_a_0*ctr_0 + _stride_force_a_1*ctr_1 + _stride_force_a_2*ctr_2 + 2*_stride_force_a_3];
      const float rho_tmp_a = rho_a;
      const float vel_0_a = u_0_a;
      const float vel_1_a = u_1_a;
      const float vel_2_a = u_2_a;
      const float streamed_0_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2];
      const float streamed_1_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 - _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_3];
      const float streamed_2_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + 2*_stride_pdfs_b_3];
      const float streamed_3_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 3*_stride_pdfs_b_3];
      const float streamed_4_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 - _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + 4*_stride_pdfs_b_3];
      const float streamed_5_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 - _stride_pdfs_b_2 + 5*_stride_pdfs_b_3];
      const float streamed_6_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_2 + 6*_stride_pdfs_b_3];
      const float streamed_7_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 - _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + 7*_stride_pdfs_b_3];
      const float streamed_8_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 - _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 - _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + 8*_stride_pdfs_b_3];
      const float streamed_9_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + 9*_stride_pdfs_b_3];
      const float streamed_10_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 - _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + 10*_stride_pdfs_b_3];
      const float streamed_11_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 - _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 - _stride_pdfs_b_2 + 11*_stride_pdfs_b_3];
      const float streamed_12_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 - _stride_pdfs_b_2 + 12*_stride_pdfs_b_3];
      const float streamed_13_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 - _stride_pdfs_b_2 + 13*_stride_pdfs_b_3];
      const float streamed_14_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 - _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 - _stride_pdfs_b_2 + 14*_stride_pdfs_b_3];
      const float streamed_15_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 - _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_2 + 15*_stride_pdfs_b_3];
      const float streamed_16_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_2 + 16*_stride_pdfs_b_3];
      const float streamed_17_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 + _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_2 + 17*_stride_pdfs_b_3];
      const float streamed_18_b = _data_pdfs_b[_stride_pdfs_b_0*ctr_0 - _stride_pdfs_b_0 + _stride_pdfs_b_1*ctr_1 + _stride_pdfs_b_2*ctr_2 + _stride_pdfs_b_2 + 18*_stride_pdfs_b_3];
      ...
      const float u_0_b = momdensity_0_b*((1.0f) / (rho_b)) + 0.5f*((1.0f) / (rho_b))*_data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2];
      const float u_1_b = momdensity_1_b*((1.0f) / (rho_b)) + 0.5f*((1.0f) / (rho_b))*_data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + _stride_force_b_3];
      const float u_2_b = momdensity_2_b*((1.0f) / (rho_b)) + 0.5f*((1.0f) / (rho_b))*_data_force_b[_stride_force_b_0*ctr_0 + _stride_force_b_1*ctr_1 + _stride_force_b_2*ctr_2 + 2*_stride_force_b_3];
...
void ColorGradientStreamSweepSinglePrecisionCUDA::runOnCellInterval(const shared_ptr<StructuredBlockStorage> & blocks, const CellInterval & globalCellInterval, cell_idx_t ghostLayers, IBlock * block, gpuStream_t stream)
{
